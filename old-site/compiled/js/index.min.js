...
$jscomp.iteratorPrototype=function(a){$jscomp.initSymbolIterator();a={next:a};a[$jscomp.global.Symbol.iterator]=function(){return this};return a};$jscomp.iteratorFromArray=function(a,b){$jscomp.initSymbolIterator();a instanceof String&&(a+="");var c=0,g={next:function(){if(c<a.length){var e=c++;return{value:b(e,a[e]),done:!1}}g.next=function(){return{done:!0,value:void 0}};return g.next()}};g[Symbol.iterator]=function(){return g};return g};
...
a)!==c});if(b.nodeType)return h.grep(a,function(a){return a===b!==c});if("string"==typeof b){if(Db.test(b))return h.filter(b,a,c);b=h.filter(b,a)}return h.grep(a,function(a){return 0<=h.inArray(a,b)!==c})}function e(a,b){do a=a[b];while(a&&1!==a.nodeType);return a}function d(a){var b=$a[a]={};return h.each(a.match(da)||[],function(a,k){b[k]=!0}),b}function f(){C.addEventListener?(C.removeEventListener("DOMContentLoaded",l,!1),a.removeEventListener("load",l,!1)):(C.detachEvent("onreadystatechange",
l),a.detachEvent("onload",l))}function l(){(C.addEventListener||"load"===event.type||"complete"===C.readyState)&&(f(),h.ready())}function m(a,b,c){if(void 0===c&&1===a.nodeType){var k="data-"+b.replace(Eb,"-$1").toLowerCase();if(c=a.getAttribute(k),"string"==typeof c){try{c="true"===c?!0:"false"===c?!1:"null"===c?null:+c+""===c?+c:Fb.test(c)?h.parseJSON(c):c}catch(B){}h.data(a,b,c)}else c=void 0}return c}function n(a){for(var b in a)if(("data"!==b||!h.isEmptyObject(a[b]))&&"toJSON"!==b)return!1;return!0}
function q(a,b,c,d){if(h.acceptData(a)){var k,p,e=h.expando,f=a.nodeType,w=f?h.cache:a,g=f?a[e]:a[e]&&e;if(g&&w[g]&&(d||w[g].data)||void 0!==c||"string"!=typeof b)return g||(g=f?a[e]=ja.pop()||h.guid++:e),w[g]||(w[g]=f?{}:{toJSON:h.noop}),("object"==typeof b||"function"==typeof b)&&(d?w[g]=h.extend(w[g],b):w[g].data=h.extend(w[g].data,b)),p=w[g],d||(p.data||(p.data={}),p=p.data),void 0!==c&&(p[h.camelCase(b)]=c),"string"==typeof b?(k=p[b],null==k&&(k=p[h.camelCase(b)])):k=p,k}}function r(a,b,c){if(h.acceptData(a)){var k,
p,d=a.nodeType,e=d?h.cache:a,f=d?a[h.expando]:h.expando;if(e[f]){if(b&&(k=c?e[f]:e[f].data)){h.isArray(b)?b=b.concat(h.map(b,h.camelCase)):b in k?b=[b]:(b=h.camelCase(b),b=b in k?[b]:b.split(" "));for(p=b.length;p--;)delete k[b[p]];if(c?!n(k):!h.isEmptyObject(k))return}(c||(delete e[f].data,n(e[f])))&&(d?h.cleanData([a],!0):v.deleteExpando||e!=e.window?delete e[f]:e[f]=null)}}}function x(){return!0}function E(){return!1}function L(){try{return C.activeElement}catch(k){}}function D(a){var b=ab.split("|");
a=a.createDocumentFragment();if(a.createElement)for(;b.length;)a.createElement(b.pop());return a}function y(a,b){var k,c,p=0,d="undefined"!==typeof a.getElementsByTagName?a.getElementsByTagName(b||"*"):"undefined"!==typeof a.querySelectorAll?a.querySelectorAll(b||"*"):void 0;if(!d)for(d=[],k=a.childNodes||a;null!=(c=k[p]);p++)!b||h.nodeName(c,b)?d.push(c):h.merge(d,y(c,b));return void 0===b||b&&h.nodeName(a,b)?h.merge([a],d):d}function T(a){La.test(a.type)&&(a.defaultChecked=a.checked)}function M(a,
b){return h.nodeName(a,"table")&&h.nodeName(11!==b.nodeType?b:b.firstChild,"tr")?a.getElementsByTagName("tbody")[0]||a.appendChild(a.ownerDocument.createElement("tbody")):a}function u(a){return a.type=(null!==h.find.attr(a,"type"))+"/"+a.type,a}function Q(a){var b=Gb.exec(a.type);return b?a.type=b[1]:a.removeAttribute("type"),a}function t(a,b){for(var k,c=0;null!=(k=a[c]);c++)h._data(k,"globalEval",!b||h._data(b[c],"globalEval"))}function z(a,b){if(1===b.nodeType&&h.hasData(a)){var k,c;var p=h._data(a);
a=h._data(b,p);var d=p.events;if(d)for(k in delete a.handle,a.events={},d)for(p=0,c=d[k].length;c>p;p++)h.event.add(b,k,d[k][p]);a.data&&(a.data=h.extend({},a.data))}}function F(b,c){var k;b=h(c.createElement(b)).appendTo(c.body);c=a.getDefaultComputedStyle&&(k=a.getDefaultComputedStyle(b[0]))?k.display:h.css(b[0],"display");return b.detach(),c}function I(a){var b=C,k=bb[a];return k||(k=F(a,b),"none"!==k&&k||(xa=(xa||h("<iframe frameborder='0' width='0' height='0'/>")).appendTo(b.documentElement),
b=(xa[0].contentWindow||xa[0].contentDocument).document,b.write(),b.close(),k=F(a,b),xa.detach()),bb[a]=k),k}function U(a,b){return{get:function(){var k=a();if(null!=k)return k?void delete this.get:(this.get=b).apply(this,arguments)}}}function R(a,b){if(b in a)return b;for(var k=b.charAt(0).toUpperCase()+b.slice(1),c=b,p=cb.length;p--;)if(b=cb[p]+k,b in a)return b;return c}function G(a,b){for(var k,c,p,d=[],e=0,f=a.length;f>e;e++)c=a[e],c.style&&(d[e]=h._data(c,"olddisplay"),k=c.style.display,b?(d[e]||
"none"!==k||(c.style.display=""),""===c.style.display&&ea(c)&&(d[e]=h._data(c,"olddisplay",I(c.nodeName)))):(p=ea(c),(k&&"none"!==k||!p)&&h._data(c,"olddisplay",p?k:h.css(c,"display"))));for(e=0;f>e;e++)c=a[e],c.style&&(b&&"none"!==c.style.display&&""!==c.style.display||(c.style.display=b?d[e]||"":"none"));return a}function W(a,b,c){return(a=Hb.exec(b))?Math.max(0,a[1]-(c||0))+(a[2]||"px"):b}function A(a,b,c,d,e){b=c===(d?"border":"content")?4:"width"===b?1:0;for(var k=0;4>b;b+=2)"margin"===c&&(k+=
h.css(a,c+ka[b],!0,e)),d?("content"===c&&(k-=h.css(a,"padding"+ka[b],!0,e)),"margin"!==c&&(k-=h.css(a,"border"+ka[b]+"Width",!0,e))):(k+=h.css(a,"padding"+ka[b],!0,e),"padding"!==c&&(k+=h.css(a,"border"+ka[b]+"Width",!0,e)));return k}function ba(a,b,c){var k=!0,d="width"===b?a.offsetWidth:a.offsetHeight,p=la(a),e=v.boxSizing&&"border-box"===h.css(a,"boxSizing",!1,p);if(0>=d||null==d){if(d=fa(a,b,p),(0>d||null==d)&&(d=a.style[b]),Ba.test(d))return d;k=e&&(v.boxSizingReliable()||d===a.style[b]);d=parseFloat(d)||
0}return d+A(a,b,c||(e?"border":"content"),k,p)+"px"}function P(a,b,c,d,e){return new P.prototype.init(a,b,c,d,e)}function N(){return setTimeout(function(){pa=void 0}),pa=h.now()}function J(a,b){var k={height:a},c=0;for(b=b?1:0;4>c;c+=2-b){var d=ka[c];k["margin"+d]=k["padding"+d]=a}return b&&(k.opacity=k.width=a),k}function X(a,b,c){for(var k,d=(ya[b]||[]).concat(ya["*"]),p=0,e=d.length;e>p;p++)if(k=d[p].call(c,b,a))return k}function Ma(a,b){var k,c,d,p,e;for(k in a)if(c=h.camelCase(k),d=b[c],p=a[k],
h.isArray(p)&&(d=p[1],p=a[k]=p[0]),k!==c&&(a[c]=p,delete a[k]),e=h.cssHooks[c],e&&"expand"in e)for(k in p=e.expand(p),delete a[c],p)k in a||(a[k]=p[k],b[k]=d);else b[c]=d}function Ca(a,b,c){var k,d=0,p=qa.length,e=h.Deferred().always(function(){delete f.elem}),f=function(){if(k)return!1;var b=pa||N();b=Math.max(0,g.startTime+g.duration-b);for(var c=1-(b/g.duration||0),d=0,p=g.tweens.length;p>d;d++)g.tweens[d].run(c);return e.notifyWith(a,[g,c,b]),1>c&&p?b:(e.resolveWith(a,[g]),!1)},g=e.promise({elem:a,
props:h.extend({},b),opts:h.extend(!0,{specialEasing:{}},c),originalProperties:b,originalOptions:c,startTime:pa||N(),duration:c.duration,tweens:[],createTween:function(b,k){b=h.Tween(a,g.opts,b,k,g.opts.specialEasing[b]||g.opts.easing);return g.tweens.push(b),b},stop:function(b){var c=0,d=b?g.tweens.length:0;if(k)return this;for(k=!0;d>c;c++)g.tweens[c].run(1);return b?e.resolveWith(a,[g,b]):e.rejectWith(a,[g,b]),this}});c=g.props;for(Ma(c,g.opts.specialEasing);p>d;d++)if(b=qa[d].call(g,a,c,g.opts))return b;
return h.map(c,X,g),h.isFunction(g.opts.start)&&g.opts.start.call(a,g),h.fx.timer(h.extend(f,{elem:a,anim:g,queue:g.opts.queue})),g.progress(g.opts.progress).done(g.opts.done,g.opts.complete).fail(g.opts.fail).always(g.opts.always)}function Da(a){return function(b,k){"string"!=typeof b&&(k=b,b="*");var c=0,d=b.toLowerCase().match(da)||[];if(h.isFunction(k))for(;b=d[c++];)"+"===b.charAt(0)?(b=b.slice(1)||"*",(a[b]=a[b]||[]).unshift(k)):(a[b]=a[b]||[]).push(k)}}function db(a,b,c,d){function k(f){var g;
return p[f]=!0,h.each(a[f]||[],function(a,f){a=f(b,c,d);return"string"!=typeof a||e||p[a]?e?!(g=a):void 0:(b.dataTypes.unshift(a),k(a),!1)}),g}var p={},e=a===Na;return k(b.dataTypes[0])||!p["*"]&&k("*")}function Oa(a,b){var k,c,d=h.ajaxSettings.flatOptions||{};for(c in b)void 0!==b[c]&&((d[c]?a:k||(k={}))[c]=b[c]);return k&&h.extend(!0,a,k),a}function Pa(a,b,c,d){var k;if(h.isArray(b))h.each(b,function(b,k){c||Jb.test(a)?d(a,k):Pa(a+"["+("object"==typeof k?b:"")+"]",k,c,d)});else if(c||"object"!==
h.type(b))d(a,b);else for(k in b)Pa(a+"["+k+"]",b[k],c,d)}function eb(){try{return new a.XMLHttpRequest}catch(k){}}function fb(a){return h.isWindow(a)?a:9===a.nodeType?a.defaultView||a.parentWindow:!1}var ja=[],ha=ja.slice,gb=ja.concat,Qa=ja.push,hb=ja.indexOf,ma={},Kb=ma.toString,ra=ma.hasOwnProperty,v={},h=function(a,b){return new h.fn.init(a,b)},Lb=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,Mb=/^-ms-/,Nb=/-([\da-z])/gi,Ob=function(a,b){return b.toUpperCase()};h.fn=h.prototype={jquery:"1.11.1",constructor:h,
selector:"",length:0,toArray:function(){return ha.call(this)},get:function(a){return null!=a?0>a?this[a+this.length]:this[a]:ha.call(this)},pushStack:function(a){a=h.merge(this.constructor(),a);return a.prevObject=this,a.context=this.context,a},each:function(a,b){return h.each(this,a,b)},map:function(a){return this.pushStack(h.map(this,function(b,k){return a.call(b,k,b)}))},slice:function(){return this.pushStack(ha.apply(this,arguments))},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},
eq:function(a){var b=this.length;a=+a+(0>a?b:0);return this.pushStack(0<=a&&b>a?[this[a]]:[])},end:function(){return this.prevObject||this.constructor(null)},push:Qa,sort:ja.sort,splice:ja.splice};h.extend=h.fn.extend=function(){var a,b,c,d,e=arguments[0]||{},f=1,g=arguments.length,l=!1;"boolean"==typeof e&&(l=e,e=arguments[f]||{},f++);"object"==typeof e||h.isFunction(e)||(e={});for(f===g&&(e=this,f--);g>f;f++)if(null!=(c=arguments[f]))for(b in c){var m=e[b];var n=c[b];e!==n&&(l&&n&&(h.isPlainObject(n)||
...
return!0},isPlainObject:function(a){var b;if(!a||"object"!==h.type(a)||a.nodeType||h.isWindow(a))return!1;try{if(a.constructor&&!ra.call(a,"constructor")&&!ra.call(a.constructor.prototype,"isPrototypeOf"))return!1}catch(w){return!1}if(v.ownLast)for(b in a)return ra.call(a,b);for(b in a);return void 0===b||ra.call(a,b)},type:function(a){return null==a?a+"":"object"==typeof a||"function"==typeof a?ma[Kb.call(a)]||"object":typeof a},globalEval:function(b){b&&h.trim(b)&&(a.execScript||function(b){a.eval.call(a,
b)})(b)},camelCase:function(a){return a.replace(Mb,"ms-").replace(Nb,Ob)},nodeName:function(a,b){return a.nodeName&&a.nodeName.toLowerCase()===b.toLowerCase()},each:function(a,b,d){var k,e=0,p=a.length,f=c(a);if(d)if(f)for(;p>e&&(k=b.apply(a[e],d),!1!==k);e++);else for(e in a){if(k=b.apply(a[e],d),!1===k)break}else if(f)for(;p>e&&(k=b.call(a[e],e,a[e]),!1!==k);e++);else for(e in a)if(k=b.call(a[e],e,a[e]),!1===k)break;return a},trim:function(a){return null==a?"":(a+"").replace(Lb,"")},makeArray:function(a,
b){b=b||[];return null!=a&&(c(Object(a))?h.merge(b,"string"==typeof a?[a]:a):Qa.call(b,a)),b},inArray:function(a,b,c){if(b){if(hb)return hb.call(b,a,c);var k=b.length;for(c=c?0>c?Math.max(0,k+c):c:0;k>c;c++)if(c in b&&b[c]===a)return c}return-1},merge:function(a,b){for(var c=+b.length,k=0,d=a.length;c>k;)a[d++]=b[k++];if(c!==c)for(;void 0!==b[k];)a[d++]=b[k++];return a.length=d,a},grep:function(a,b,c){for(var k=[],d=0,e=a.length,f=!c;e>d;d++)c=!b(a[d],d),c!==f&&k.push(a[d]);return k},map:function(a,
b,d){var k=0,e=a.length,f=[];if(c(a))for(;e>k;k++){var p=b(a[k],k,d);null!=p&&f.push(p)}else for(k in a)p=b(a[k],k,d),null!=p&&f.push(p);return gb.apply([],f)},guid:1,proxy:function(a,b){var c,k,d;return"string"==typeof b&&(d=a[b],b=a,a=d),h.isFunction(a)?(c=ha.call(arguments,2),k=function(){return a.apply(b||this,c.concat(ha.call(arguments)))},k.guid=a.guid=a.guid||h.guid++,k):void 0},now:function(){return+new Date},support:v});h.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),
function(a,b){ma["[object "+b+"]"]=b.toLowerCase()});var va=function(a){function b(a,b,c,k){var d,e,f,p,h;if((b?b.ownerDocument||b:T)!==G&&Aa(b),b=b||G,c=c||[],!a||"string"!=typeof a)return c;if(1!==(p=b.nodeType)&&9!==p)return[];if(y&&!k){if(d=ya.exec(a))if(f=d[1])if(9===p){if(e=b.getElementById(f),!e||!e.parentNode)return c;if(e.id===f)return c.push(e),c}else{if(b.ownerDocument&&(e=b.ownerDocument.getElementById(f))&&J(b,e)&&e.id===f)return c.push(e),c}else{if(d[2])return X.apply(c,b.getElementsByTagName(a)),
c;if((f=d[3])&&S.getElementsByClassName&&b.getElementsByClassName)return X.apply(c,b.getElementsByClassName(f)),c}if(S.qsa&&(!R||!R.test(a))){if(e=d=V,f=b,h=9===p&&a,1===p&&"object"!==b.nodeName.toLowerCase()){p=ma(a);(d=b.getAttribute("id"))?e=d.replace(Da,"\\$&"):b.setAttribute("id",e);e="[id='"+e+"'] ";for(f=p.length;f--;)p[f]=e+z(p[f]);f=Ca.test(a)&&m(b.parentNode)||b;h=p.join(",")}if(h)try{return X.apply(c,f.querySelectorAll(h)),c}catch(Bc){}finally{d||b.removeAttribute("id")}}}return x(a.replace(ca,
"$1"),b,c,k)}function c(){function a(c,k){return b.push(c+" ")>O.cacheLength&&delete a[b.shift()],a[c+" "]=k}var b=[];return a}function k(a){return a[V]=!0,a}function d(a){var b=G.createElement("div");try{return!!a(b)}catch(zc){return!1}finally{b.parentNode&&b.parentNode.removeChild(b)}}function e(a,b){var c=a.split("|");for(a=a.length;a--;)O.attrHandle[c[a]]=b}function f(a,b){var c=b&&a,k=c&&1===a.nodeType&&1===b.nodeType&&(~b.sourceIndex||-2147483648)-(~a.sourceIndex||-2147483648);if(k)return k;
...
0,c=a.length,k="";c>b;b++)k+=a[b].value;return k}function F(a,b,c){var k=b.dir,d=c&&"parentNode"===k,e=N++;return b.first?function(b,c,e){for(;b=b[k];)if(1===b.nodeType||d)return a(b,c,e)}:function(b,c,f){var p,h,g=[M,e];if(f)for(;b=b[k];){if((1===b.nodeType||d)&&a(b,c,f))return!0}else for(;b=b[k];)if(1===b.nodeType||d){if(h=b[V]||(b[V]={}),(p=h[k])&&p[0]===M&&p[1]===e)return g[2]=p[2];if(h[k]=g,g[2]=a(b,c,f))return!0}}}function q(a){return 1<a.length?function(b,c,k){for(var d=a.length;d--;)if(!a[d](b,
c,k))return!1;return!0}:a[0]}function I(a,b,c,k,d){for(var e,f=[],p=0,h=a.length,g=null!=b;h>p;p++)(e=a[p])&&(!c||c(e,k,d))&&(f.push(e),g&&b.push(p));return f}function U(a,c,d,e,f,p){return e&&!e[V]&&(e=U(e)),f&&!f[V]&&(f=U(f,p)),k(function(k,p,h,g){var l,w=[],H=[],m=p.length,B;if(!(B=k)){B=c||"*";for(var K=h.nodeType?[h]:h,n=[],za=0,z=K.length;z>za;za++)b(B,K[za],n);B=n}B=!a||!k&&c?B:I(B,w,a,h,g);K=d?f||(k?a:m||e)?[]:p:B;if(d&&d(B,K,h,g),e){var aa=I(K,H);e(aa,[],h,g);for(h=aa.length;h--;)(l=aa[h])&&
(K[H[h]]=!(B[H[h]]=l))}if(k){if(f||a){if(f){aa=[];for(h=K.length;h--;)(l=K[h])&&aa.push(B[h]=l);f(null,K=[],aa,g)}for(h=K.length;h--;)(l=K[h])&&-1<(aa=f?Z.call(k,l):w[h])&&(k[aa]=!(p[aa]=l))}}else K=I(K===p?K.splice(m,K.length):K),f?f(null,p,K,g):X.apply(p,K)})}function r(a){var b,c,k=a.length,d=O.relative[a[0].type];var e=d||O.relative[" "];for(var f=d?1:0,p=F(function(a){return a===b},e,!0),h=F(function(a){return-1<Z.call(b,a)},e,!0),g=[function(a,c,k){return!d&&(k||c!==D)||((b=c).nodeType?p(a,
c,k):h(a,c,k))}];k>f;f++)if(e=O.relative[a[f].type])g=[F(q(g),e)];else{if(e=O.filter[a[f].type].apply(null,a[f].matches),e[V]){for(c=++f;k>c&&!O.relative[a[c].type];c++);return U(1<f&&q(g),1<f&&z(a.slice(0,f-1).concat({value:" "===a[f-2].type?"*":""})).replace(ca,"$1"),e,c>f&&r(a.slice(f,c)),k>c&&r(a=a.slice(c)),k>c&&z(a))}g.push(e)}return q(g)}function L(a,c){var d=0<c.length,e=0<a.length,f=function(k,f,p,h,g){var l,w,H,m=0,B="0",K=k&&[],n=[],z=D,aa=k||e&&O.find.TAG("*",g),za=M+=null==z?1:Math.random()||
.1,F=aa.length;for(g&&(D=f!==G&&f);B!==F&&null!=(l=aa[B]);B++){if(e&&l){for(w=0;H=a[w++];)if(H(l,f,p)){h.push(l);break}g&&(M=za)}d&&((l=!H&&l)&&m--,k&&K.push(l))}if(m+=B,d&&B!==m){for(w=0;H=c[w++];)H(K,n,f,p);if(k){if(0<m)for(;B--;)K[B]||n[B]||(n[B]=da.call(h));n=I(n)}X.apply(h,n);g&&!k&&0<n.length&&1<m+c.length&&b.uniqueSort(h)}return g&&(M=za,D=z),K};return d?k(f):f}var E,t,x,D,u,v,G,A,y,R,C,W,J,V="sizzle"+-new Date,T=a.document,M=0,N=0,Q=c(),ba=c(),P=c(),Y=function(a,b){return a===b&&(v=!0),0},
Rb={}.hasOwnProperty,sa=[],da=sa.pop,ja=sa.push,X=sa.push,ha=sa.slice,Z=sa.indexOf||function(a){for(var b=0,c=this.length;c>b;b++)if(this[b]===a)return b;return-1},ka="(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w","w#"),la="\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)(?:[\\x20\\t\\r\\n\\f]*([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|("+ka+"))|)[\\x20\\t\\r\\n\\f]*\\]",fa=":((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|"+
la+")*)|.*)\\)|)",ca=/^[\x20\t\r\n\f]+|((?:^|[^\\])(?:\\.)*)[\x20\t\r\n\f]+$/g,na=/^[\x20\t\r\n\f]*,[\x20\t\r\n\f]*/,oa=/^[\x20\t\r\n\f]*([>+~]|[\x20\t\r\n\f])[\x20\t\r\n\f]*/,pa=/=[\x20\t\r\n\f]*([^\]'"]*?)[\x20\t\r\n\f]*\]/g,ra=new RegExp(fa),va=new RegExp("^"+ka+"$"),ia={ID:/^#((?:\\.|[\w-]|[^\x00-\xa0])+)/,CLASS:/^\.((?:\\.|[\w-]|[^\x00-\xa0])+)/,TAG:new RegExp("^("+"(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w","w*")+")"),ATTR:new RegExp("^"+la),PSEUDO:new RegExp("^"+fa),CHILD:/^:(only|first|last|nth|nth-last)-(child|of-type)(?:\([\x20\t\r\n\f]*(even|odd|(([+-]|)(\d*)n|)[\x20\t\r\n\f]*(?:([+-]|)[\x20\t\r\n\f]*(\d+)|))[\x20\t\r\n\f]*\)|)/i,
bool:/^(?:checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)$/i,needsContext:/^[\x20\t\r\n\f]*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\([\x20\t\r\n\f]*((?:-\d)?\d*)[\x20\t\r\n\f]*\)|)(?=[^-]|$)/i},wa=/^(?:input|select|textarea|button)$/i,xa=/^h\d$/i,ea=/^[^{]+\{\s*\[native \w/,ya=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,Ca=/[+~]/,Da=/'|\\/g,ta=/\\([\da-f]{1,6}[\x20\t\r\n\f]?|([\x20\t\r\n\f])|.)/ig,ua=function(a,b,c){a="0x"+b-65536;
return a!==a||c?b:0>a?String.fromCharCode(a+65536):String.fromCharCode(a>>10|55296,1023&a|56320)};try{X.apply(sa=ha.call(T.childNodes),T.childNodes),sa[T.childNodes.length].nodeType}catch(za){X={apply:sa.length?function(a,b){ja.apply(a,ha.call(b))}:function(a,b){for(var c=a.length,k=0;a[c++]=b[k++];);a.length=c-1}}}var S=b.support={};var Ba=b.isXML=function(a){return(a=a&&(a.ownerDocument||a).documentElement)?"HTML"!==a.nodeName:!1};var Aa=b.setDocument=function(a){var b,c=a?a.ownerDocument||a:T;
a=c.defaultView;return c!==G&&9===c.nodeType&&c.documentElement?(G=c,A=c.documentElement,y=!Ba(c),a&&a!==a.top&&(a.addEventListener?a.addEventListener("unload",function(){Aa()},!1):a.attachEvent&&a.attachEvent("onunload",function(){Aa()})),S.attributes=d(function(a){return a.className="i",!a.getAttribute("className")}),S.getElementsByTagName=d(function(a){return a.appendChild(c.createComment("")),!a.getElementsByTagName("*").length}),S.getElementsByClassName=ea.test(c.getElementsByClassName)&&d(function(a){return a.innerHTML=
"<div class='a'></div><div class='a i'></div>",a.firstChild.className="i",2===a.getElementsByClassName("i").length}),S.getById=d(function(a){return A.appendChild(a).id=V,!c.getElementsByName||!c.getElementsByName(V).length}),S.getById?(O.find.ID=function(a,b){if("undefined"!==typeof b.getElementById&&y)return(a=b.getElementById(a))&&a.parentNode?[a]:[]},O.filter.ID=function(a){var b=a.replace(ta,ua);return function(a){return a.getAttribute("id")===b}}):(delete O.find.ID,O.filter.ID=function(a){var b=
a.replace(ta,ua);return function(a){return(a="undefined"!==typeof a.getAttributeNode&&a.getAttributeNode("id"))&&a.value===b}}),O.find.TAG=S.getElementsByTagName?function(a,b){return"undefined"!==typeof b.getElementsByTagName?b.getElementsByTagName(a):void 0}:function(a,b){var c=[],k=0;b=b.getElementsByTagName(a);if("*"===a){for(;a=b[k++];)1===a.nodeType&&c.push(a);return c}return b},O.find.CLASS=S.getElementsByClassName&&function(a,b){return"undefined"!==typeof b.getElementsByClassName&&y?b.getElementsByClassName(a):
void 0},C=[],R=[],(S.qsa=ea.test(c.querySelectorAll))&&(d(function(a){a.innerHTML="<select msallowclip=''><option selected=''></option></select>";a.querySelectorAll("[msallowclip^='']").length&&R.push("[*^$]=[\\x20\\t\\r\\n\\f]*(?:''|\"\")");a.querySelectorAll("[selected]").length||R.push("\\[[\\x20\\t\\r\\n\\f]*(?:value|checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)");a.querySelectorAll(":checked").length||R.push(":checked")}),
d(function(a){var b=c.createElement("input");b.setAttribute("type","hidden");a.appendChild(b).setAttribute("name","D");a.querySelectorAll("[name=d]").length&&R.push("name[\\x20\\t\\r\\n\\f]*[*^$|!~]?=");a.querySelectorAll(":enabled").length||R.push(":enabled",":disabled");a.querySelectorAll("*,:x");R.push(",.*:")})),(S.matchesSelector=ea.test(W=A.matches||A.webkitMatchesSelector||A.mozMatchesSelector||A.oMatchesSelector||A.msMatchesSelector))&&d(function(a){S.disconnectedMatch=W.call(a,"div");W.call(a,
"[s!='']:x");C.push("!=",fa)}),R=R.length&&new RegExp(R.join("|")),C=C.length&&new RegExp(C.join("|")),b=ea.test(A.compareDocumentPosition),J=b||ea.test(A.contains)?function(a,b){var c=9===a.nodeType?a.documentElement:a;b=b&&b.parentNode;return a===b||!(!b||1!==b.nodeType||!(c.contains?c.contains(b):a.compareDocumentPosition&&16&a.compareDocumentPosition(b)))}:function(a,b){if(b)for(;b=b.parentNode;)if(b===a)return!0;return!1},Y=b?function(a,b){if(a===b)return v=!0,0;var k=!a.compareDocumentPosition-
!b.compareDocumentPosition;return k?k:(k=(a.ownerDocument||a)===(b.ownerDocument||b)?a.compareDocumentPosition(b):1,1&k||!S.sortDetached&&b.compareDocumentPosition(a)===k?a===c||a.ownerDocument===T&&J(T,a)?-1:b===c||b.ownerDocument===T&&J(T,b)?1:u?Z.call(u,a)-Z.call(u,b):0:4&k?-1:1)}:function(a,b){if(a===b)return v=!0,0;var k=0,d=a.parentNode,e=b.parentNode,p=[a],h=[b];if(!d||!e)return a===c?-1:b===c?1:d?-1:e?1:u?Z.call(u,a)-Z.call(u,b):0;if(d===e)return f(a,b);for(;a=a.parentNode;)p.unshift(a);for(a=
b;a=a.parentNode;)h.unshift(a);for(;p[k]===h[k];)k++;return k?f(p[k],h[k]):p[k]===T?-1:h[k]===T?1:0},c):G};b.matches=function(a,c){return b(a,null,null,c)};b.matchesSelector=function(a,c){if((a.ownerDocument||a)!==G&&Aa(a),c=c.replace(pa,"='$1']"),!(!S.matchesSelector||!y||C&&C.test(c)||R&&R.test(c)))try{var k=W.call(a,c);if(k||S.disconnectedMatch||a.document&&11!==a.document.nodeType)return k}catch(Ac){}return 0<b(c,G,null,[a]).length};b.contains=function(a,b){return(a.ownerDocument||a)!==G&&Aa(a),
J(a,b)};b.attr=function(a,b){(a.ownerDocument||a)!==G&&Aa(a);var c=O.attrHandle[b.toLowerCase()];c=c&&Rb.call(O.attrHandle,b.toLowerCase())?c(a,b,!y):void 0;return void 0!==c?c:S.attributes||!y?a.getAttribute(b):(c=a.getAttributeNode(b))&&c.specified?c.value:null};b.error=function(a){throw Error("Syntax error, unrecognized expression: "+a);};b.uniqueSort=function(a){var b,c=[],k=0,d=0;if(v=!S.detectDuplicates,u=!S.sortStable&&a.slice(0),a.sort(Y),v){for(;b=a[d++];)b===a[d]&&(k=c.push(d));for(;k--;)a.splice(c[k],
1)}return u=null,a};var qa=b.getText=function(a){var b,c="",k=0;if(b=a.nodeType)if(1===b||9===b||11===b){if("string"==typeof a.textContent)return a.textContent;for(a=a.firstChild;a;a=a.nextSibling)c+=qa(a)}else{if(3===b||4===b)return a.nodeValue}else for(;b=a[k++];)c+=qa(b);return c};var O=b.selectors={cacheLength:50,createPseudo:k,match:ia,attrHandle:{},find:{},relative:{">":{dir:"parentNode",first:!0}," ":{dir:"parentNode"},"+":{dir:"previousSibling",first:!0},"~":{dir:"previousSibling"}},preFilter:{ATTR:function(a){return a[1]=
a[1].replace(ta,ua),a[3]=(a[3]||a[4]||a[5]||"").replace(ta,ua),"~="===a[2]&&(a[3]=" "+a[3]+" "),a.slice(0,4)},CHILD:function(a){return a[1]=a[1].toLowerCase(),"nth"===a[1].slice(0,3)?(a[3]||b.error(a[0]),a[4]=+(a[4]?a[5]+(a[6]||1):2*("even"===a[3]||"odd"===a[3])),a[5]=+(a[7]+a[8]||"odd"===a[3])):a[3]&&b.error(a[0]),a},PSEUDO:function(a){var b,c=!a[6]&&a[2];return ia.CHILD.test(a[0])?null:(a[3]?a[2]=a[4]||a[5]||"":c&&ra.test(c)&&(b=ma(c,!0))&&(b=c.indexOf(")",c.length-b)-c.length)&&(a[0]=a[0].slice(0,
b),a[2]=c.slice(0,b)),a.slice(0,3))}},filter:{TAG:function(a){var b=a.replace(ta,ua).toLowerCase();return"*"===a?function(){return!0}:function(a){return a.nodeName&&a.nodeName.toLowerCase()===b}},CLASS:function(a){var b=Q[a+" "];return b||(b=new RegExp("(^|[\\x20\\t\\r\\n\\f])"+a+"([\\x20\\t\\r\\n\\f]|$)"),Q(a,function(a){return b.test("string"==typeof a.className&&a.className||"undefined"!==typeof a.getAttribute&&a.getAttribute("class")||"")}))},ATTR:function(a,c,k){return function(d){d=b.attr(d,
a);return null==d?"!="===c:c?(d+="","="===c?d===k:"!="===c?d!==k:"^="===c?k&&0===d.indexOf(k):"*="===c?k&&-1<d.indexOf(k):"$="===c?k&&d.slice(-k.length)===k:"~="===c?-1<(" "+d+" ").indexOf(k):"|="===c?d===k||d.slice(0,k.length+1)===k+"-":!1):!0}},CHILD:function(a,b,c,k,d){var e="nth"!==a.slice(0,3),f="last"!==a.slice(-4),p="of-type"===b;return 1===k&&0===d?function(a){return!!a.parentNode}:function(b,c,h){var g;c=e!==f?"nextSibling":"previousSibling";var l=b.parentNode,w=p&&b.nodeName.toLowerCase();
h=!h&&!p;if(l){if(e){for(;c;){for(g=b;g=g[c];)if(p?g.nodeName.toLowerCase()===w:1===g.nodeType)return!1;var H=c="only"===a&&!H&&"nextSibling"}return!0}if(H=[f?l.firstChild:l.lastChild],f&&h){h=l[V]||(l[V]={});var m=h[a]||[];var B=m[0]===M&&m[1];var K=m[0]===M&&m[2];for(g=B&&l.childNodes[B];g=++B&&g&&g[c]||(K=B=0)||H.pop();)if(1===g.nodeType&&++K&&g===b){h[a]=[M,B,K];break}}else if(h&&(m=(b[V]||(b[V]={}))[a])&&m[0]===M)K=m[1];else for(;(g=++B&&g&&g[c]||(K=B=0)||H.pop())&&((p?g.nodeName.toLowerCase()!==
w:1!==g.nodeType)||!++K||(h&&((g[V]||(g[V]={}))[a]=[M,K]),g!==b)););return K-=d,K===k||0===K%k&&0<=K/k}}},PSEUDO:function(a,c){var d,e=O.pseudos[a]||O.setFilters[a.toLowerCase()]||b.error("unsupported pseudo: "+a);return e[V]?e(c):1<e.length?(d=[a,a,"",c],O.setFilters.hasOwnProperty(a.toLowerCase())?k(function(a,b){for(var k,d=e(a,c),f=d.length;f--;)k=Z.call(a,d[f]),a[k]=!(b[k]=d[f])}):function(a){return e(a,0,d)}):e}},pseudos:{not:k(function(a){var b=[],c=[],d=t(a.replace(ca,"$1"));return d[V]?k(function(a,
b,c,k){var e;c=d(a,null,k,[]);for(k=a.length;k--;)(e=c[k])&&(a[k]=!(b[k]=e))}):function(a,k,e){return b[0]=a,d(b,null,e,c),!c.pop()}}),has:k(function(a){return function(c){return 0<b(a,c).length}}),contains:k(function(a){return function(b){return-1<(b.textContent||b.innerText||qa(b)).indexOf(a)}}),lang:k(function(a){return va.test(a||"")||b.error("unsupported lang: "+a),a=a.replace(ta,ua).toLowerCase(),function(b){var c;do if(c=y?b.lang:b.getAttribute("xml:lang")||b.getAttribute("lang"))return c=
c.toLowerCase(),c===a||0===c.indexOf(a+"-");while((b=b.parentNode)&&1===b.nodeType);return!1}}),target:function(b){var c=a.location&&a.location.hash;return c&&c.slice(1)===b.id},root:function(a){return a===A},focus:function(a){return a===G.activeElement&&(!G.hasFocus||G.hasFocus())&&!!(a.type||a.href||~a.tabIndex)},enabled:function(a){return!1===a.disabled},disabled:function(a){return!0===a.disabled},checked:function(a){var b=a.nodeName.toLowerCase();return"input"===b&&!!a.checked||"option"===b&&
!!a.selected},selected:function(a){return a.parentNode&&a.parentNode.selectedIndex,!0===a.selected},empty:function(a){for(a=a.firstChild;a;a=a.nextSibling)if(6>a.nodeType)return!1;return!0},parent:function(a){return!O.pseudos.empty(a)},header:function(a){return xa.test(a.nodeName)},input:function(a){return wa.test(a.nodeName)},button:function(a){var b=a.nodeName.toLowerCase();return"input"===b&&"button"===a.type||"button"===b},text:function(a){var b;return"input"===a.nodeName.toLowerCase()&&"text"===
a.type&&(null==(b=a.getAttribute("type"))||"text"===b.toLowerCase())},first:l(function(){return[0]}),last:l(function(a,b){return[b-1]}),eq:l(function(a,b,c){return[0>c?c+b:c]}),even:l(function(a,b){for(var c=0;b>c;c+=2)a.push(c);return a}),odd:l(function(a,b){for(var c=1;b>c;c+=2)a.push(c);return a}),lt:l(function(a,b,c){for(b=0>c?c+b:c;0<=--b;)a.push(b);return a}),gt:l(function(a,b,c){for(c=0>c?c+b:c;++c<b;)a.push(c);return a})}};O.pseudos.nth=O.pseudos.eq;for(E in{radio:!0,checkbox:!0,file:!0,password:!0,
image:!0})O.pseudos[E]=h(E);for(E in{submit:!0,reset:!0})O.pseudos[E]=g(E);n.prototype=O.filters=O.pseudos;O.setFilters=new n;var ma=b.tokenize=function(a,c){var k,d,e,f,p;if(f=ba[a+" "])return c?0:f.slice(0);f=a;var h=[];for(p=O.preFilter;f;){g&&!(k=na.exec(f))||(k&&(f=f.slice(k[0].length)||f),h.push(d=[]));var g=!1;(k=oa.exec(f))&&(g=k.shift(),d.push({value:g,type:k[0].replace(ca," ")}),f=f.slice(g.length));for(e in O.filter)!(k=ia[e].exec(f))||p[e]&&!(k=p[e](k))||(g=k.shift(),d.push({value:g,type:e,
matches:k}),f=f.slice(g.length));if(!g)break}return c?f.length:f?b.error(a):ba(a,h).slice(0)};return t=b.compile=function(a,b){var c,k=[],d=[],e=P[a+" "];if(!e){b||(b=ma(a));for(c=b.length;c--;)e=r(b[c]),e[V]?k.push(e):d.push(e);e=P(a,L(d,k));e.selector=a}return e},x=b.select=function(a,b,c,k){var d,e,f,p,h,g="function"==typeof a&&a,l=!k&&ma(a=g.selector||a);if(c=c||[],1===l.length){if(e=l[0]=l[0].slice(0),2<e.length&&"ID"===(f=e[0]).type&&S.getById&&9===b.nodeType&&y&&O.relative[e[1].type]){if(b=
(O.find.ID(f.matches[0].replace(ta,ua),b)||[])[0],!b)return c;g&&(b=b.parentNode);a=a.slice(e.shift().value.length)}for(d=ia.needsContext.test(a)?0:e.length;d--&&(f=e[d],!O.relative[p=f.type]);)if((h=O.find[p])&&(k=h(f.matches[0].replace(ta,ua),Ca.test(e[0].type)&&m(b.parentNode)||b))){if(e.splice(d,1),a=k.length&&z(e),!a)return X.apply(c,k),c;break}}return(g||t(a,l))(k,b,!y,c,Ca.test(a)&&m(b.parentNode)||b),c},S.sortStable=V.split("").sort(Y).join("")===V,S.detectDuplicates=!!v,Aa(),S.sortDetached=
d(function(a){return 1&a.compareDocumentPosition(G.createElement("div"))}),d(function(a){return a.innerHTML="<a href='#'></a>","#"===a.firstChild.getAttribute("href")})||e("type|href|height|width",function(a,b,c){return c?void 0:a.getAttribute(b,"type"===b.toLowerCase()?1:2)}),S.attributes&&d(function(a){return a.innerHTML="<input/>",a.firstChild.setAttribute("value",""),""===a.firstChild.getAttribute("value")})||e("value",function(a,b,c){return c||"input"!==a.nodeName.toLowerCase()?void 0:a.defaultValue}),
d(function(a){return null==a.getAttribute("disabled")})||e("checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped",function(a,b,c){var k;return c?void 0:!0===a[b]?b.toLowerCase():(k=a.getAttributeNode(b))&&k.specified?k.value:null}),b}(a);h.find=va;h.expr=va.selectors;h.expr[":"]=h.expr.pseudos;h.unique=va.uniqueSort;h.text=va.getText;h.isXMLDoc=va.isXML;h.contains=va.contains;var jb=h.expr.match.needsContext,kb=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,
Db=/^.[^:#\[\.,]*$/;h.filter=function(a,b,c){var k=b[0];return c&&(a=":not("+a+")"),1===b.length&&1===k.nodeType?h.find.matchesSelector(k,a)?[k]:[]:h.find.matches(a,h.grep(b,function(a){return 1===a.nodeType}))};h.fn.extend({find:function(a){var b,c=[],k=this,d=k.length;if("string"!=typeof a)return this.pushStack(h(a).filter(function(){for(b=0;d>b;b++)if(h.contains(k[b],this))return!0}));for(b=0;d>b;b++)h.find(a,k[b],c);return c=this.pushStack(1<d?h.unique(c):c),c.selector=this.selector?this.selector+
" "+a:a,c},filter:function(a){return this.pushStack(g(this,a||[],!1))},not:function(a){return this.pushStack(g(this,a||[],!0))},is:function(a){return!!g(this,"string"==typeof a&&jb.test(a)?h(a):a||[],!1).length}});var C=a.document,Sb=/^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/;(h.fn.init=function(a,b){var c,k;if(!a)return this;if("string"==typeof a){if(c="<"===a.charAt(0)&&">"===a.charAt(a.length-1)&&3<=a.length?[null,a,null]:Sb.exec(a),!c||!c[1]&&b)return!b||b.jquery?(b||Ea).find(a):this.constructor(b).find(a);
if(c[1]){if(b=b instanceof h?b[0]:b,h.merge(this,h.parseHTML(c[1],b&&b.nodeType?b.ownerDocument||b:C,!0)),kb.test(c[1])&&h.isPlainObject(b))for(c in b)h.isFunction(this[c])?this[c](b[c]):this.attr(c,b[c]);return this}if(k=C.getElementById(c[2]),k&&k.parentNode){if(k.id!==c[2])return Ea.find(a);this.length=1;this[0]=k}return this.context=C,this.selector=a,this}return a.nodeType?(this.context=this[0]=a,this.length=1,this):h.isFunction(a)?"undefined"!=typeof Ea.ready?Ea.ready(a):a(h):(void 0!==a.selector&&
(this.selector=a.selector,this.context=a.context),h.makeArray(a,this))}).prototype=h.fn;var Ea=h(C);var Tb=/^(?:parents|prev(?:Until|All))/,Ub={children:!0,contents:!0,next:!0,prev:!0};h.extend({dir:function(a,b,c){var k=[];for(a=a[b];a&&9!==a.nodeType&&(void 0===c||1!==a.nodeType||!h(a).is(c));)1===a.nodeType&&k.push(a),a=a[b];return k},sibling:function(a,b){for(var c=[];a;a=a.nextSibling)1===a.nodeType&&a!==b&&c.push(a);return c}});h.fn.extend({has:function(a){var b,c=h(a,this),k=c.length;return this.filter(function(){for(b=
0;k>b;b++)if(h.contains(this,c[b]))return!0})},closest:function(a,b){for(var c,k=0,d=this.length,e=[],f=jb.test(a)||"string"!=typeof a?h(a,b||this.context):0;d>k;k++)for(c=this[k];c&&c!==b;c=c.parentNode)if(11>c.nodeType&&(f?-1<f.index(c):1===c.nodeType&&h.find.matchesSelector(c,a))){e.push(c);break}return this.pushStack(1<e.length?h.unique(e):e)},index:function(a){return a?"string"==typeof a?h.inArray(this[0],h(a)):h.inArray(a.jquery?a[0]:a,this):this[0]&&this[0].parentNode?this.first().prevAll().length:
...
(k=c),k&&"string"==typeof k&&(d=h.filter(k,d)),1<this.length&&(Ub[a]||(d=h.unique(d)),Tb.test(a)&&(d=d.reverse())),this.pushStack(d)}});var da=/\S+/g,$a={};h.Callbacks=function(a){a="string"==typeof a?$a[a]||d(a):h.extend({},a);var b,c,k,e,f,g,l=[],m=!a.once&&[],n=function(d){c=a.memory&&d;k=!0;f=g||0;g=0;e=l.length;for(b=!0;l&&e>f;f++)if(!1===l[f].apply(d[0],d[1])&&a.stopOnFalse){c=!1;break}b=!1;l&&(m?m.length&&n(m.shift()):c?l=[]:z.disable())},z={add:function(){if(l){var k=l.length;!function Pb(b){h.each(b,
function(b,c){b=h.type(c);"function"===b?a.unique&&z.has(c)||l.push(c):c&&c.length&&"string"!==b&&Pb(c)})}(arguments);b?e=l.length:c&&(g=k,n(c))}return this},remove:function(){return l&&h.each(arguments,function(a,c){for(var k;-1<(k=h.inArray(c,l,k));)l.splice(k,1),b&&(e>=k&&e--,f>=k&&f--)}),this},has:function(a){return a?-1<h.inArray(a,l):!(!l||!l.length)},empty:function(){return l=[],e=0,this},disable:function(){return l=m=c=void 0,this},disabled:function(){return!l},lock:function(){return m=void 0,
...
h},b[1^a][2].disable,b[2][2].lock);d[e[0]]=function(){return d[e[0]+"With"](this===d?k:this,arguments),this};d[e[0]+"With"]=f.fireWith}),k.promise(d),a&&a.call(d,d),d},when:function(a){var b=0,c=ha.call(arguments),k=c.length,d=1!==k||a&&h.isFunction(a.promise)?k:0,e=1===d?a:h.Deferred(),f=function(a,b,c){return function(k){b[a]=this;c[a]=1<arguments.length?ha.call(arguments):k;c===l?e.notifyWith(b,c):--d||e.resolveWith(b,c)}},g;if(1<k){var l=Array(k);var m=Array(k);for(g=Array(k);k>b;b++)c[b]&&h.isFunction(c[b].promise)?
c[b].promise().done(f(b,g,c)).fail(e.reject).progress(f(b,m,l)):--d}return d||e.resolveWith(g,c),e.promise()}});var Fa;h.fn.ready=function(a){return h.ready.promise().done(a),this};h.extend({isReady:!1,readyWait:1,holdReady:function(a){a?h.readyWait++:h.ready(!0)},ready:function(a){if(!0===a?!--h.readyWait:!h.isReady){if(!C.body)return setTimeout(h.ready);h.isReady=!0;!0!==a&&0<--h.readyWait||(Fa.resolveWith(C,[h]),h.fn.triggerHandler&&(h(C).triggerHandler("ready"),h(C).off("ready")))}}});h.ready.promise=
function(b){if(!Fa)if(Fa=h.Deferred(),"complete"===C.readyState)setTimeout(h.ready);else if(C.addEventListener)C.addEventListener("DOMContentLoaded",l,!1),a.addEventListener("load",l,!1);else{C.attachEvent("onreadystatechange",l);a.attachEvent("onload",l);var c=!1;try{c=null==a.frameElement&&C.documentElement}catch(w){}c&&c.doScroll&&!function H(){if(!h.isReady){try{c.doScroll("left")}catch(B){return setTimeout(H,50)}f();h.ready()}}()}return Fa.promise(b)};for(var Vb in h(v))break;v.ownLast="0"!==
Vb;v.inlineBlockNeedsLayout=!1;h(function(){var a,b,c,d;(c=C.getElementsByTagName("body")[0])&&c.style&&(b=C.createElement("div"),d=C.createElement("div"),d.style.cssText="position:absolute;border:0;width:0;height:0;top:0;left:-9999px",c.appendChild(d).appendChild(b),"undefined"!==typeof b.style.zoom&&(b.style.cssText="display:inline;margin:0;border:0;padding:1px;width:1px;zoom:1",v.inlineBlockNeedsLayout=a=3===b.offsetWidth,a&&(c.style.zoom=1)),c.removeChild(d))});(function(){var a=C.createElement("div");
if(null==v.deleteExpando){v.deleteExpando=!0;try{delete a.test}catch(p){v.deleteExpando=!1}}})();h.acceptData=function(a){var b=h.noData[(a.nodeName+" ").toLowerCase()],c=+a.nodeType||1;return 1!==c&&9!==c?!1:!b||!0!==b&&a.getAttribute("classid")===b};var Fb=/^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,Eb=/([A-Z])/g;h.extend({cache:{},noData:{"applet ":!0,"embed ":!0,"object ":"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"},hasData:function(a){return a=a.nodeType?h.cache[a[h.expando]]:a[h.expando],!!a&&!n(a)},data:function(a,
b,c){return q(a,b,c)},removeData:function(a,b){return r(a,b)},_data:function(a,b,c){return q(a,b,c,!0)},_removeData:function(a,b){return r(a,b,!0)}});h.fn.extend({data:function(a,b){var c,k,d,e=this[0],f=e&&e.attributes;if(void 0===a){if(this.length&&(d=h.data(e),1===e.nodeType&&!h._data(e,"parsedAttrs"))){for(c=f.length;c--;)f[c]&&(k=f[c].name,0===k.indexOf("data-")&&(k=h.camelCase(k.slice(5)),m(e,k,d[k])));h._data(e,"parsedAttrs",!0)}return d}return"object"==typeof a?this.each(function(){h.data(this,
...
a)})},dequeue:function(a){return this.each(function(){h.dequeue(this,a)})},clearQueue:function(a){return this.queue(a||"fx",[])},promise:function(a,b){var c,k=1,d=h.Deferred(),e=this,f=this.length,g=function(){--k||d.resolveWith(e,[e])};"string"!=typeof a&&(b=a,a=void 0);for(a=a||"fx";f--;)(c=h._data(e[f],a+"queueHooks"))&&c.empty&&(k++,c.empty.add(g));return g(),d.promise(b)}});var Ga=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,ka=["Top","Right","Bottom","Left"],ea=function(a,b){return a=b||a,"none"===
h.css(a,"display")||!h.contains(a.ownerDocument,a)},ca=h.access=function(a,b,c,d,e,f,g){var k=0,p=a.length,l=null==c;if("object"===h.type(c))for(k in e=!0,c)h.access(a,b,k,c[k],!0,f,g);else if(void 0!==d&&(e=!0,h.isFunction(d)||(g=!0),l&&(g?(b.call(a,d),b=null):(l=b,b=function(a,b,c){return l.call(h(a),c)})),b))for(;p>k;k++)b(a[k],c,g?d:d.call(a[k],k,b(a[k],c)));return e?a:l?b.call(a):p?b(a[0],c):f},La=/^(?:checkbox|radio)$/i;!function(){var a=C.createElement("input"),b=C.createElement("div"),c=C.createDocumentFragment();
if(b.innerHTML="  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>",v.leadingWhitespace=3===b.firstChild.nodeType,v.tbody=!b.getElementsByTagName("tbody").length,v.htmlSerialize=!!b.getElementsByTagName("link").length,v.html5Clone="<:nav></:nav>"!==C.createElement("nav").cloneNode(!0).outerHTML,a.type="checkbox",a.checked=!0,c.appendChild(a),v.appendChecked=a.checked,b.innerHTML="<textarea>x</textarea>",v.noCloneChecked=!!b.cloneNode(!0).lastChild.defaultValue,c.appendChild(b),b.innerHTML=
"<input type='radio' checked='checked' name='t'/>",v.checkClone=b.cloneNode(!0).cloneNode(!0).lastChild.checked,v.noCloneEvent=!0,b.attachEvent&&(b.attachEvent("onclick",function(){v.noCloneEvent=!1}),b.cloneNode(!0).click()),null==v.deleteExpando){v.deleteExpando=!0;try{delete b.test}catch(H){v.deleteExpando=!1}}}();(function(){var b,c=C.createElement("div");for(b in{submit:!0,change:!0,focusin:!0}){var d="on"+b;(v[b+"Bubbles"]=d in a)||(c.setAttribute(d,"t"),v[b+"Bubbles"]=!1===c.attributes[d].expando)}})();
var Ra=/^(?:input|select|textarea)$/i,Wb=/^key/,Xb=/^(?:mouse|pointer|contextmenu)|click/,lb=/^(?:focusinfocus|focusoutblur)$/,mb=/^([^.]*)(?:\.(.+)|)$/;h.event={global:{},add:function(a,b,c,d,e){var k,f,g,p,l,w,m,H;if(f=h._data(a)){c.handler&&(g=c,c=g.handler,e=g.selector);c.guid||(c.guid=h.guid++);(k=f.events)||(k=f.events={});(l=f.handle)||(l=f.handle=function(a){return"undefined"===typeof h||a&&h.event.triggered===a.type?void 0:h.event.dispatch.apply(l.elem,arguments)},l.elem=a);b=(b||"").match(da)||
[""];for(f=b.length;f--;){var B=mb.exec(b[f])||[];var n=H=B[1];B=(B[2]||"").split(".").sort();n&&(p=h.event.special[n]||{},n=(e?p.delegateType:p.bindType)||n,p=h.event.special[n]||{},w=h.extend({type:n,origType:H,data:d,handler:c,guid:c.guid,selector:e,needsContext:e&&h.expr.match.needsContext.test(e),namespace:B.join(".")},g),(m=k[n])||(m=k[n]=[],m.delegateCount=0,p.setup&&!1!==p.setup.call(a,d,B,l)||(a.addEventListener?a.addEventListener(n,l,!1):a.attachEvent&&a.attachEvent("on"+n,l))),p.add&&(p.add.call(a,
w),w.handler.guid||(w.handler.guid=c.guid)),e?m.splice(m.delegateCount++,0,w):m.push(w),h.event.global[n]=!0)}a=null}},remove:function(a,b,c,d,e){var k,f,g,l,p,w,m,H,B=h.hasData(a)&&h._data(a);if(B&&(p=B.events)){b=(b||"").match(da)||[""];for(l=b.length;l--;)if(f=mb.exec(b[l])||[],w=H=f[1],m=(f[2]||"").split(".").sort(),w){var n=h.event.special[w]||{};w=(d?n.delegateType:n.bindType)||w;var z=p[w]||[];f=f[2]&&new RegExp("(^|\\.)"+m.join("\\.(?:.*\\.|)")+"(\\.|$)");for(g=k=z.length;k--;){var F=z[k];
!e&&H!==F.origType||c&&c.guid!==F.guid||f&&!f.test(F.namespace)||d&&d!==F.selector&&("**"!==d||!F.selector)||(z.splice(k,1),F.selector&&z.delegateCount--,n.remove&&n.remove.call(a,F))}g&&!z.length&&(n.teardown&&!1!==n.teardown.call(a,m,B.handle)||h.removeEvent(a,w,B.handle),delete p[w])}else for(w in p)h.event.remove(a,w+b[l],c,d,!0);h.isEmptyObject(p)&&(delete B.handle,h._removeData(a,"events"))}},trigger:function(b,c,d,e){var k,f,g,l,p=[d||C],w=ra.call(b,"type")?b.type:b;var m=ra.call(b,"namespace")?
b.namespace.split("."):[];if(g=k=d=d||C,3!==d.nodeType&&8!==d.nodeType&&!lb.test(w+h.event.triggered)&&(0<=w.indexOf(".")&&(m=w.split("."),w=m.shift(),m.sort()),f=0>w.indexOf(":")&&"on"+w,b=b[h.expando]?b:new h.Event(w,"object"==typeof b&&b),b.isTrigger=e?2:3,b.namespace=m.join("."),b.namespace_re=b.namespace?new RegExp("(^|\\.)"+m.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,b.result=void 0,b.target||(b.target=d),c=null==c?[b]:h.makeArray(c,[b]),l=h.event.special[w]||{},e||!l.trigger||!1!==l.trigger.apply(d,
c))){if(!e&&!l.noBubble&&!h.isWindow(d)){var H=l.delegateType||w;for(lb.test(H+w)||(g=g.parentNode);g;g=g.parentNode)p.push(g),k=g;k===(d.ownerDocument||C)&&p.push(k.defaultView||k.parentWindow||a)}for(m=0;(g=p[m++])&&!b.isPropagationStopped();)b.type=1<m?H:l.bindType||w,(k=(h._data(g,"events")||{})[b.type]&&h._data(g,"handle"))&&k.apply(g,c),(k=f&&g[f])&&k.apply&&h.acceptData(g)&&(b.result=k.apply(g,c),!1===b.result&&b.preventDefault());if(b.type=w,!(e||b.isDefaultPrevented()||l._default&&!1!==l._default.apply(p.pop(),
c))&&h.acceptData(d)&&f&&d[w]&&!h.isWindow(d)){(k=d[f])&&(d[f]=null);h.event.triggered=w;try{d[w]()}catch(Ib){}h.event.triggered=void 0;k&&(d[f]=k)}return b.result}},dispatch:function(a){a=h.event.fix(a);var b,c,k,d,e=ha.call(arguments);var f=(h._data(this,"events")||{})[a.type]||[];var g=h.event.special[a.type]||{};if(e[0]=a,a.delegateTarget=this,!g.preDispatch||!1!==g.preDispatch.call(this,a)){var l=h.event.handlers.call(this,a,f);for(f=0;(k=l[f++])&&!a.isPropagationStopped();)for(a.currentTarget=
...
c))};h.Event=function(a,b){return this instanceof h.Event?(a&&a.type?(this.originalEvent=a,this.type=a.type,this.isDefaultPrevented=a.defaultPrevented||void 0===a.defaultPrevented&&!1===a.returnValue?x:E):this.type=a,b&&h.extend(this,b),this.timeStamp=a&&a.timeStamp||h.now(),void(this[h.expando]=!0)):new h.Event(a,b)};h.Event.prototype={isDefaultPrevented:E,isPropagationStopped:E,isImmediatePropagationStopped:E,preventDefault:function(){var a=this.originalEvent;this.isDefaultPrevented=x;a&&(a.preventDefault?
a.preventDefault():a.returnValue=!1)},stopPropagation:function(){var a=this.originalEvent;this.isPropagationStopped=x;a&&(a.stopPropagation&&a.stopPropagation(),a.cancelBubble=!0)},stopImmediatePropagation:function(){var a=this.originalEvent;this.isImmediatePropagationStopped=x;a&&a.stopImmediatePropagation&&a.stopImmediatePropagation();this.stopPropagation()}};h.each({mouseenter:"mouseover",mouseleave:"mouseout",pointerenter:"pointerover",pointerleave:"pointerout"},function(a,b){h.event.special[a]=
{delegateType:b,bindType:b,handle:function(a){var c,d=a.relatedTarget,k=a.handleObj;return(!d||d!==this&&!h.contains(this,d))&&(a.type=k.origType,c=k.handler.apply(this,arguments),a.type=b),c}}});v.submitBubbles||(h.event.special.submit={setup:function(){return h.nodeName(this,"form")?!1:void h.event.add(this,"click._submit keypress._submit",function(a){a=a.target;(a=h.nodeName(a,"input")||h.nodeName(a,"button")?a.form:void 0)&&!h._data(a,"submitBubbles")&&(h.event.add(a,"submit._submit",function(a){a._submit_bubble=
!0}),h._data(a,"submitBubbles",!0))})},postDispatch:function(a){a._submit_bubble&&(delete a._submit_bubble,this.parentNode&&!a.isTrigger&&h.event.simulate("submit",this.parentNode,a,!0))},teardown:function(){return h.nodeName(this,"form")?!1:void h.event.remove(this,"._submit")}});v.changeBubbles||(h.event.special.change={setup:function(){return Ra.test(this.nodeName)?(("checkbox"===this.type||"radio"===this.type)&&(h.event.add(this,"propertychange._change",function(a){"checked"===a.originalEvent.propertyName&&
...
return this!==b||a.isSimulated||a.isTrigger||"radio"!==b.type&&"checkbox"!==b.type?a.handleObj.handler.apply(this,arguments):void 0},teardown:function(){return h.event.remove(this,"._change"),!Ra.test(this.nodeName)}});v.focusinBubbles||h.each({focus:"focusin",blur:"focusout"},function(a,b){var c=function(a){h.event.simulate(b,a.target,h.event.fix(a),!0)};h.event.special[b]={setup:function(){var d=this.ownerDocument||this,e=h._data(d,b);e||d.addEventListener(a,c,!0);h._data(d,b,(e||0)+1)},teardown:function(){var d=
this.ownerDocument||this,e=h._data(d,b)-1;e?h._data(d,b,e):(d.removeEventListener(a,c,!0),h._removeData(d,b))}}});h.fn.extend({on:function(a,b,c,d,e){var k,f;if("object"==typeof a){"string"!=typeof b&&(c=c||b,b=void 0);for(k in a)this.on(k,b,c,a[k],e);return this}if(null==c&&null==d?(d=b,c=b=void 0):null==d&&("string"==typeof b?(d=c,c=void 0):(d=c,c=b,b=void 0)),!1===d)d=E;else if(!d)return this;return 1===e&&(f=d,d=function(a){return h().off(a),f.apply(this,arguments)},d.guid=f.guid||(f.guid=h.guid++)),
this.each(function(){h.event.add(this,a,d,c,b)})},one:function(a,b,c,d){return this.on(a,b,c,d,1)},off:function(a,b,c){var d,e;if(a&&a.preventDefault&&a.handleObj)return d=a.handleObj,h(a.delegateTarget).off(d.namespace?d.origType+"."+d.namespace:d.origType,d.selector,d.handler),this;if("object"==typeof a){for(e in a)this.off(e,b,a[e]);return this}return(!1===b||"function"==typeof b)&&(c=b,b=void 0),!1===c&&(c=E),this.each(function(){h.event.remove(this,a,c,b)})},trigger:function(a,b){return this.each(function(){h.event.trigger(a,
b,this)})},triggerHandler:function(a,b){var c=this[0];return c?h.event.trigger(a,b,c,!0):void 0}});var ab="abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",Yb=/ jQuery\d+="(?:null|\d+)"/g,nb=new RegExp("<(?:"+ab+")[\\s/>]","i"),Sa=/^\s+/,ob=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,pb=/<([\w:]+)/,qb=/<tbody/i,Zb=/<|&#?\w+;/,$b=/<(?:script|style|link)/i,ac=/checked\s*(?:[^=]|=\s*.checked.)/i,
rb=/^$|\/(?:java|ecma)script/i,Gb=/^true\/(.*)/,bc=/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g,Y={option:[1,"<select multiple='multiple'>","</select>"],legend:[1,"<fieldset>","</fieldset>"],area:[1,"<map>","</map>"],param:[1,"<object>","</object>"],thead:[1,"<table>","</table>"],tr:[2,"<table><tbody>","</tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],td:[3,"<table><tbody><tr>","</tr></tbody></table>"],_default:v.htmlSerialize?[0,"",""]:[1,"X<div>","</div>"]},Ta=D(C).appendChild(C.createElement("div"));
Y.optgroup=Y.option;Y.tbody=Y.tfoot=Y.colgroup=Y.caption=Y.thead;Y.th=Y.td;h.extend({clone:function(a,b,c){var d,e,k,f=h.contains(a.ownerDocument,a);if(v.html5Clone||h.isXMLDoc(a)||!nb.test("<"+a.nodeName+">")?e=a.cloneNode(!0):(Ta.innerHTML=a.outerHTML,Ta.removeChild(e=Ta.firstChild)),!(v.noCloneEvent&&v.noCloneChecked||1!==a.nodeType&&11!==a.nodeType||h.isXMLDoc(a))){var g=y(e);var l=y(a);for(k=0;null!=(d=l[k]);++k)if(g[k]){var p=void 0,m,w=d,n=g[k];if(1===n.nodeType){if(m=n.nodeName.toLowerCase(),
!v.noCloneEvent&&n[h.expando]){d=h._data(n);for(p in d.events)h.removeEvent(n,p,d.handle);n.removeAttribute(h.expando)}"script"===m&&n.text!==w.text?(u(n).text=w.text,Q(n)):"object"===m?(n.parentNode&&(n.outerHTML=w.outerHTML),v.html5Clone&&w.innerHTML&&!h.trim(n.innerHTML)&&(n.innerHTML=w.innerHTML)):"input"===m&&La.test(w.type)?(n.defaultChecked=n.checked=w.checked,n.value!==w.value&&(n.value=w.value)):"option"===m?n.defaultSelected=n.selected=w.defaultSelected:("input"===m||"textarea"===m)&&(n.defaultValue=
w.defaultValue)}}}if(b)if(c)for(l=l||y(a),g=g||y(e),k=0;null!=(d=l[k]);k++)z(d,g[k]);else z(a,e);return g=y(e,"script"),0<g.length&&t(g,!f&&y(a,"script")),e},buildFragment:function(a,b,c,d){for(var e,k,f,g,l,p,m,w=a.length,n=D(b),H=[],z=0;w>z;z++)if(k=a[z],k||0===k)if("object"===h.type(k))h.merge(H,k.nodeType?[k]:k);else if(Zb.test(k)){g=g||n.appendChild(b.createElement("div"));l=(pb.exec(k)||["",""])[1].toLowerCase();m=Y[l]||Y._default;g.innerHTML=m[1]+k.replace(ob,"<$1></$2>")+m[2];for(e=m[0];e--;)g=
g.lastChild;if(!v.leadingWhitespace&&Sa.test(k)&&H.push(b.createTextNode(Sa.exec(k)[0])),!v.tbody)for(e=(k="table"!==l||qb.test(k)?"<table>"!==m[1]||qb.test(k)?0:g:g.firstChild)&&k.childNodes.length;e--;)h.nodeName(p=k.childNodes[e],"tbody")&&!p.childNodes.length&&k.removeChild(p);h.merge(H,g.childNodes);for(g.textContent="";g.firstChild;)g.removeChild(g.firstChild);g=n.lastChild}else H.push(b.createTextNode(k));g&&n.removeChild(g);v.appendChecked||h.grep(y(H,"input"),T);for(z=0;k=H[z++];)if((!d||
-1===h.inArray(k,d))&&(f=h.contains(k.ownerDocument,k),g=y(n.appendChild(k),"script"),f&&t(g),c))for(e=0;k=g[e++];)rb.test(k.type||"")&&c.push(k);return n},cleanData:function(a,b){for(var c,d,e,k,f=0,g=h.expando,l=h.cache,p=v.deleteExpando,m=h.event.special;null!=(c=a[f]);f++)if((b||h.acceptData(c))&&(e=c[g],k=e&&l[e])){if(k.events)for(d in k.events)m[d]?h.event.remove(c,d):h.removeEvent(c,d,k.handle);l[e]&&(delete l[e],p?delete c[g]:"undefined"!==typeof c.removeAttribute?c.removeAttribute(g):c[g]=
null,ja.push(e))}}});h.fn.extend({text:function(a){return ca(this,function(a){return void 0===a?h.text(this):this.empty().append((this[0]&&this[0].ownerDocument||C).createTextNode(a))},null,a,arguments.length)},append:function(){return this.domManip(arguments,function(a){1!==this.nodeType&&11!==this.nodeType&&9!==this.nodeType||M(this,a).appendChild(a)})},prepend:function(){return this.domManip(arguments,function(a){if(1===this.nodeType||11===this.nodeType||9===this.nodeType){var b=M(this,a);b.insertBefore(a,
b.firstChild)}})},before:function(){return this.domManip(arguments,function(a){this.parentNode&&this.parentNode.insertBefore(a,this)})},after:function(){return this.domManip(arguments,function(a){this.parentNode&&this.parentNode.insertBefore(a,this.nextSibling)})},remove:function(a,b){for(var c=a?h.filter(a,this):this,d=0;null!=(a=c[d]);d++)b||1!==a.nodeType||h.cleanData(y(a)),a.parentNode&&(b&&h.contains(a.ownerDocument,a)&&t(y(a,"script")),a.parentNode.removeChild(a));return this},empty:function(){for(var a,
b=0;null!=(a=this[b]);b++){for(1===a.nodeType&&h.cleanData(y(a,!1));a.firstChild;)a.removeChild(a.firstChild);a.options&&h.nodeName(a,"select")&&(a.options.length=0)}return this},clone:function(a,b){return a=null==a?!1:a,b=null==b?a:b,this.map(function(){return h.clone(this,a,b)})},html:function(a){return ca(this,function(a){var b=this[0]||{},c=0,d=this.length;if(void 0===a)return 1===b.nodeType?b.innerHTML.replace(Yb,""):void 0;if(!("string"!=typeof a||$b.test(a)||!v.htmlSerialize&&nb.test(a)||!v.leadingWhitespace&&
Sa.test(a)||Y[(pb.exec(a)||["",""])[1].toLowerCase()])){a=a.replace(ob,"<$1></$2>");try{for(;d>c;c++)b=this[c]||{},1===b.nodeType&&(h.cleanData(y(b,!1)),b.innerHTML=a);b=0}catch(K){}}b&&this.empty().append(a)},null,a,arguments.length)},replaceWith:function(){var a=arguments[0];return this.domManip(arguments,function(b){a=this.parentNode;h.cleanData(y(this));a&&a.replaceChild(b,this)}),a&&(a.length||a.nodeType)?this:this.remove()},detach:function(a){return this.remove(a,!0)},domManip:function(a,b){a=
gb.apply([],a);var c,d,e,k=0,f=this.length,g=this,l=f-1,p=a[0],m=h.isFunction(p);if(m||1<f&&"string"==typeof p&&!v.checkClone&&ac.test(p))return this.each(function(c){var d=g.eq(c);m&&(a[0]=p.call(this,c,d.html()));d.domManip(a,b)});if(f&&(e=h.buildFragment(a,this[0].ownerDocument,!1,this),c=e.firstChild,1===e.childNodes.length&&(e=c),c)){var n=h.map(y(e,"script"),u);for(d=n.length;f>k;k++)c=e,k!==l&&(c=h.clone(c,!0,!0),d&&h.merge(n,y(c,"script"))),b.call(this[k],c,k);if(d)for(e=n[n.length-1].ownerDocument,
h.map(n,Q),k=0;d>k;k++)c=n[k],rb.test(c.type||"")&&!h._data(c,"globalEval")&&h.contains(e,c)&&(c.src?h._evalUrl&&h._evalUrl(c.src):h.globalEval((c.text||c.textContent||c.innerHTML||"").replace(bc,"")));e=c=null}return this}});h.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,b){h.fn[a]=function(a){for(var c=0,d=[],e=h(a),k=e.length-1;k>=c;c++)a=c===k?this:this.clone(!0),h(e[c])[b](a),Qa.apply(d,a.get());return this.pushStack(d)}});
var xa,bb={};!function(){var a;v.shrinkWrapBlocks=function(){if(null!=a)return a;a=!1;var b,c,d;return c=C.getElementsByTagName("body")[0],c&&c.style?(b=C.createElement("div"),d=C.createElement("div"),d.style.cssText="position:absolute;border:0;width:0;height:0;top:0;left:-9999px",c.appendChild(d).appendChild(b),"undefined"!==typeof b.style.zoom&&(b.style.cssText="-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:1px;width:1px;zoom:1",
b.appendChild(C.createElement("div")).style.width="5px",a=3!==b.offsetWidth),c.removeChild(d),a):void 0}}();var sb=/^margin/,Ba=new RegExp("^("+Ga+")(?!px)[a-z%]+$","i"),la,fa,cc=/^(top|right|bottom|left)$/;a.getComputedStyle?(la=function(a){return a.ownerDocument.defaultView.getComputedStyle(a,null)},fa=function(a,b,c){var d,e,k,f,g=a.style;return c=c||la(a),f=c?c.getPropertyValue(b)||c[b]:void 0,c&&(""!==f||h.contains(a.ownerDocument,a)||(f=h.style(a,b)),Ba.test(f)&&sb.test(b)&&(d=g.width,e=g.minWidth,
k=g.maxWidth,g.minWidth=g.maxWidth=g.width=f,f=c.width,g.width=d,g.minWidth=e,g.maxWidth=k)),void 0===f?f:f+""}):C.documentElement.currentStyle&&(la=function(a){return a.currentStyle},fa=function(a,b,c){var d,e,f,k,g=a.style;return c=c||la(a),k=c?c[b]:void 0,null==k&&g&&g[b]&&(k=g[b]),Ba.test(k)&&!cc.test(b)&&(d=g.left,e=a.runtimeStyle,f=e&&e.left,f&&(e.left=a.currentStyle.left),g.left="fontSize"===b?"1em":k,k=g.pixelLeft+"px",g.left=d,f&&(e.left=f)),void 0===k?k:k+""||"auto"});!function(){var b,
c,d,e,f,g,l;if(b=C.createElement("div"),b.innerHTML="  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>",d=b.getElementsByTagName("a")[0],c=d&&d.style){var m=function(){var b,c,d,k;(c=C.getElementsByTagName("body")[0])&&c.style&&(b=C.createElement("div"),d=C.createElement("div"),d.style.cssText="position:absolute;border:0;width:0;height:0;top:0;left:-9999px",c.appendChild(d).appendChild(b),b.style.cssText="-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;display:block;margin-top:1%;top:1%;border:1px;padding:1px;width:4px;position:absolute",
e=f=!1,l=!0,a.getComputedStyle&&(e="1%"!==(a.getComputedStyle(b,null)||{}).top,f="4px"===(a.getComputedStyle(b,null)||{width:"4px"}).width,k=b.appendChild(C.createElement("div")),k.style.cssText=b.style.cssText="-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0",k.style.marginRight=k.style.width="0",b.style.width="1px",l=!parseFloat((a.getComputedStyle(k,null)||{}).marginRight)),b.innerHTML="<table><tr><td></td><td>t</td></tr></table>",
...
h.extend(v,{reliableHiddenOffsets:function(){return null==g&&m(),g},boxSizingReliable:function(){return null==f&&m(),f},pixelPosition:function(){return null==e&&m(),e},reliableMarginRight:function(){return null==l&&m(),l}})}}();h.swap=function(a,b,c,d){var e,f={};for(e in b)f[e]=a.style[e],a.style[e]=b[e];c=c.apply(a,d||[]);for(e in b)a.style[e]=f[e];return c};var Ua=/alpha\([^)]*\)/i,dc=/opacity\s*=\s*([^)]*)/,ec=/^(none|table(?!-c[ea]).+)/,Hb=new RegExp("^("+Ga+")(.*)$","i"),fc=new RegExp("^([+-])=("+
Ga+")","i"),gc={position:"absolute",visibility:"hidden",display:"block"},tb={letterSpacing:"0",fontWeight:"400"},cb=["Webkit","O","Moz","ms"];h.extend({cssHooks:{opacity:{get:function(a,b){if(b)return a=fa(a,"opacity"),""===a?"1":a}}},cssNumber:{columnCount:!0,fillOpacity:!0,flexGrow:!0,flexShrink:!0,fontWeight:!0,lineHeight:!0,opacity:!0,order:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":v.cssFloat?"cssFloat":"styleFloat"},style:function(a,b,c,d){if(a&&3!==a.nodeType&&8!==a.nodeType&&
a.style){var e,f,k,g=h.camelCase(b),l=a.style;if(b=h.cssProps[g]||(h.cssProps[g]=R(l,g)),k=h.cssHooks[b]||h.cssHooks[g],void 0===c)return k&&"get"in k&&void 0!==(e=k.get(a,!1,d))?e:l[b];if(f=typeof c,"string"===f&&(e=fc.exec(c))&&(c=(e[1]+1)*e[2]+parseFloat(h.css(a,b)),f="number"),null!=c&&c===c&&("number"!==f||h.cssNumber[g]||(c+="px"),v.clearCloneStyle||""!==c||0!==b.indexOf("background")||(l[b]="inherit"),!(k&&"set"in k&&void 0===(c=k.set(a,c,d)))))try{l[b]=c}catch(yc){}}},css:function(a,b,c,d){var e,
f,k,g=h.camelCase(b);return b=h.cssProps[g]||(h.cssProps[g]=R(a.style,g)),k=h.cssHooks[b]||h.cssHooks[g],k&&"get"in k&&(f=k.get(a,!0,c)),void 0===f&&(f=fa(a,b,d)),"normal"===f&&b in tb&&(f=tb[b]),""===c||c?(e=parseFloat(f),!0===c||h.isNumeric(e)?e||0:f):f}});h.each(["height","width"],function(a,b){h.cssHooks[b]={get:function(a,c,d){return c?ec.test(h.css(a,"display"))&&0===a.offsetWidth?h.swap(a,gc,function(){return ba(a,b,d)}):ba(a,b,d):void 0},set:function(a,c,d){var e=d&&la(a);return W(a,c,d?A(a,
b,d,v.boxSizing&&"border-box"===h.css(a,"boxSizing",!1,e),e):0)}}});v.opacity||(h.cssHooks.opacity={get:function(a,b){return dc.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?.01*parseFloat(RegExp.$1)+"":b?"1":""},set:function(a,b){var c=a.style;a=a.currentStyle;var d=h.isNumeric(b)?"alpha(opacity="+100*b+")":"",e=a&&a.filter||c.filter||"";c.zoom=1;(1<=b||""===b)&&""===h.trim(e.replace(Ua,""))&&c.removeAttribute&&(c.removeAttribute("filter"),""===b||a&&!a.filter)||(c.filter=Ua.test(e)?
e.replace(Ua,d):e+" "+d)}});h.cssHooks.marginRight=U(v.reliableMarginRight,function(a,b){return b?h.swap(a,{display:"inline-block"},fa,[a,"marginRight"]):void 0});h.each({margin:"",padding:"",border:"Width"},function(a,b){h.cssHooks[a+b]={expand:function(c){var d=0,e={};for(c="string"==typeof c?c.split(" "):[c];4>d;d++)e[a+ka[d]+b]=c[d]||c[d-2]||c[0];return e}};sb.test(a)||(h.cssHooks[a+b].set=W)});h.fn.extend({css:function(a,b){return ca(this,function(a,b,c){var d,e={},f=0;if(h.isArray(b)){c=la(a);
for(d=b.length;d>f;f++)e[b[f]]=h.css(a,b[f],!1,c);return e}return void 0!==c?h.style(a,b,c):h.css(a,b)},a,b,1<arguments.length)},show:function(){return G(this,!0)},hide:function(){return G(this)},toggle:function(a){return"boolean"==typeof a?a?this.show():this.hide():this.each(function(){ea(this)?h(this).show():h(this).hide()})}});h.Tween=P;P.prototype={constructor:P,init:function(a,b,c,d,e,f){this.elem=a;this.prop=c;this.easing=e||"swing";this.options=b;this.start=this.now=this.cur();this.end=d;this.unit=
f||(h.cssNumber[c]?"":"px")},cur:function(){var a=P.propHooks[this.prop];return a&&a.get?a.get(this):P.propHooks._default.get(this)},run:function(a){var b,c=P.propHooks[this.prop];return this.pos=b=this.options.duration?h.easing[this.easing](a,this.options.duration*a,0,1,this.options.duration):a,this.now=(this.end-this.start)*b+this.start,this.options.step&&this.options.step.call(this.elem,this.now,this),c&&c.set?c.set(this):P.propHooks._default.set(this),this}};P.prototype.init.prototype=P.prototype;
...
swing:function(a){return.5-Math.cos(a*Math.PI)/2}};h.fx=P.prototype.init;h.fx.step={};var pa,Ha,hc=/^(?:toggle|show|hide)$/,ub=new RegExp("^(?:([+-])=|)("+Ga+")([a-z%]*)$","i"),ic=/queueHooks$/,qa=[function(a,b,c){var d,e,f,k,g,l,p,m=this,n={},w=a.style,z=a.nodeType&&ea(a),F=h._data(a,"fxshow");c.queue||(k=h._queueHooks(a,"fx"),null==k.unqueued&&(k.unqueued=0,g=k.empty.fire,k.empty.fire=function(){k.unqueued||g()}),k.unqueued++,m.always(function(){m.always(function(){k.unqueued--;h.queue(a,"fx").length||
k.empty.fire()})}));1===a.nodeType&&("height"in b||"width"in b)&&(c.overflow=[w.overflow,w.overflowX,w.overflowY],l=h.css(a,"display"),p="none"===l?h._data(a,"olddisplay")||I(a.nodeName):l,"inline"===p&&"none"===h.css(a,"float")&&(v.inlineBlockNeedsLayout&&"inline"!==I(a.nodeName)?w.zoom=1:w.display="inline-block"));c.overflow&&(w.overflow="hidden",v.shrinkWrapBlocks()||m.always(function(){w.overflow=c.overflow[0];w.overflowX=c.overflow[1];w.overflowY=c.overflow[2]}));for(d in b)if(e=b[d],hc.exec(e)){if(delete b[d],
f=f||"toggle"===e,e===(z?"hide":"show")){if("show"!==e||!F||void 0===F[d])continue;z=!0}n[d]=F&&F[d]||h.style(a,d)}else l=void 0;if(h.isEmptyObject(n))"inline"===("none"===l?I(a.nodeName):l)&&(w.display=l);else for(d in F?"hidden"in F&&(z=F.hidden):F=h._data(a,"fxshow",{}),f&&(F.hidden=!z),z?h(a).show():m.done(function(){h(a).hide()}),m.done(function(){var b;h._removeData(a,"fxshow");for(b in n)h.style(a,b,n[b])}),n)b=X(z?F[d]:0,d,m),d in F||(F[d]=b.start,z&&(b.end=b.start,b.start="width"===d||"height"===
d?1:0))}],ya={"*":[function(a,b){var c=this.createTween(a,b),d=c.cur(),e=(b=ub.exec(b))&&b[3]||(h.cssNumber[a]?"":"px"),f=(h.cssNumber[a]||"px"!==e&&+d)&&ub.exec(h.css(c.elem,a)),k=1,g=20;if(f&&f[3]!==e){e=e||f[3];b=b||[];f=+d||1;do k=k||".5",f/=k,h.style(c.elem,a,f+e);while(k!==(k=c.cur()/d)&&1!==k&&--g)}return b&&(f=c.start=+f||+d||0,c.unit=e,c.end=b[1]?f+(b[1]+1)*b[2]:+b[2]),c}]};h.Animation=h.extend(Ca,{tweener:function(a,b){h.isFunction(a)?(b=a,a=["*"]):a=a.split(" ");for(var c,d=0,e=a.length;e>
d;d++)c=a[d],ya[c]=ya[c]||[],ya[c].unshift(b)},prefilter:function(a,b){b?qa.unshift(a):qa.push(a)}});h.speed=function(a,b,c){var d=a&&"object"==typeof a?h.extend({},a):{complete:c||!c&&b||h.isFunction(a)&&a,duration:a,easing:c&&b||b&&!h.isFunction(b)&&b};return d.duration=h.fx.off?0:"number"==typeof d.duration?d.duration:d.duration in h.fx.speeds?h.fx.speeds[d.duration]:h.fx.speeds._default,(null==d.queue||!0===d.queue)&&(d.queue="fx"),d.old=d.complete,d.complete=function(){h.isFunction(d.old)&&d.old.call(this);
...
a&&this.queue(a||"fx",[]),this.each(function(){var b=!0,e=null!=a&&a+"queueHooks",f=h.timers,k=h._data(this);if(e)k[e]&&k[e].stop&&d(k[e]);else for(e in k)k[e]&&k[e].stop&&ic.test(e)&&d(k[e]);for(e=f.length;e--;)f[e].elem!==this||null!=a&&f[e].queue!==a||(f[e].anim.stop(c),b=!1,f.splice(e,1));!b&&c||h.dequeue(this,a)})},finish:function(a){return!1!==a&&(a=a||"fx"),this.each(function(){var b=h._data(this),c=b[a+"queue"];var d=b[a+"queueHooks"];var e=h.timers,f=c?c.length:0;b.finish=!0;h.queue(this,
a,[]);d&&d.stop&&d.stop.call(this,!0);for(d=e.length;d--;)e[d].elem===this&&e[d].queue===a&&(e[d].anim.stop(!0),e.splice(d,1));for(d=0;f>d;d++)c[d]&&c[d].finish&&c[d].finish.call(this);delete b.finish})}});h.each(["toggle","show","hide"],function(a,b){var c=h.fn[b];h.fn[b]=function(a,d,e){return null==a||"boolean"==typeof a?c.apply(this,arguments):this.animate(J(b,!0),a,d,e)}});h.each({slideDown:J("show"),slideUp:J("hide"),slideToggle:J("toggle"),fadeIn:{opacity:"show"},fadeOut:{opacity:"hide"},fadeToggle:{opacity:"toggle"}},
function(a,b){h.fn[a]=function(a,c,d){return this.animate(b,a,c,d)}});h.timers=[];h.fx.tick=function(){var a=h.timers,b=0;for(pa=h.now();b<a.length;b++){var c=a[b];c()||a[b]!==c||a.splice(b--,1)}a.length||h.fx.stop();pa=void 0};h.fx.timer=function(a){h.timers.push(a);a()?h.fx.start():h.timers.pop()};h.fx.interval=13;h.fx.start=function(){Ha||(Ha=setInterval(h.fx.tick,h.fx.interval))};h.fx.stop=function(){clearInterval(Ha);Ha=null};h.fx.speeds={slow:600,fast:200,_default:400};h.fn.delay=function(a,
b){return a=h.fx?h.fx.speeds[a]||a:a,b=b||"fx",this.queue(b,function(b,c){var d=setTimeout(b,a);c.stop=function(){clearTimeout(d)}})};(function(){var a=C.createElement("div");a.setAttribute("className","t");a.innerHTML="  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>";var b=a.getElementsByTagName("a")[0];var c=C.createElement("select");var d=c.appendChild(C.createElement("option"));var e=a.getElementsByTagName("input")[0];b.style.cssText="top:1px";v.getSetAttribute="t"!==a.className;
v.style=/top/.test(b.getAttribute("style"));v.hrefNormalized="/a"===b.getAttribute("href");v.checkOn=!!e.value;v.optSelected=d.selected;v.enctype=!!C.createElement("form").enctype;c.disabled=!0;v.optDisabled=!d.disabled;e=C.createElement("input");e.setAttribute("value","");v.input=""===e.getAttribute("value");e.value="t";e.setAttribute("type","radio");v.radioValue="t"===e.value})();var jc=/\r/g;h.fn.extend({val:function(a){var b,c,d,e=this[0];if(arguments.length)return d=h.isFunction(a),this.each(function(c){var e;
1===this.nodeType&&(e=d?a.call(this,c,h(this).val()):a,null==e?e="":"number"==typeof e?e+="":h.isArray(e)&&(e=h.map(e,function(a){return null==a?"":a+""})),b=h.valHooks[this.type]||h.valHooks[this.nodeName.toLowerCase()],b&&"set"in b&&void 0!==b.set(this,e,"value")||(this.value=e))});if(e)return b=h.valHooks[e.type]||h.valHooks[e.nodeName.toLowerCase()],b&&"get"in b&&void 0!==(c=b.get(e,"value"))?c:(c=e.value,"string"==typeof c?c.replace(jc,""):null==c?"":c)}});h.extend({valHooks:{option:{get:function(a){var b=
h.find.attr(a,"value");return null!=b?b:h.trim(h.text(a))}},select:{get:function(a){for(var b,c=a.options,d=a.selectedIndex,e="select-one"===a.type||0>d,f=e?null:[],k=e?d+1:c.length,g=0>d?k:e?d:0;k>g;g++)if(b=c[g],!(!b.selected&&g!==d||(v.optDisabled?b.disabled:null!==b.getAttribute("disabled"))||b.parentNode.disabled&&h.nodeName(b.parentNode,"optgroup"))){if(a=h(b).val(),e)return a;f.push(a)}return f},set:function(a,b){var c,d,e=a.options;b=h.makeArray(b);for(var f=e.length;f--;)if(d=e[f],0<=h.inArray(h.valHooks.option.get(d),
b))try{d.selected=c=!0}catch(aa){d.scrollHeight}else d.selected=!1;return c||(a.selectedIndex=-1),e}}}});h.each(["radio","checkbox"],function(){h.valHooks[this]={set:function(a,b){return h.isArray(b)?a.checked=0<=h.inArray(h(a).val(),b):void 0}};v.checkOn||(h.valHooks[this].get=function(a){return null===a.getAttribute("value")?"on":a.value})});var ia,Z=h.expr.attrHandle,Va=/^(?:checked|selected)$/i,na=v.getSetAttribute,Ia=v.input;h.fn.extend({attr:function(a,b){return ca(this,h.attr,a,b,1<arguments.length)},
removeAttr:function(a){return this.each(function(){h.removeAttr(this,a)})}});h.extend({attr:function(a,b,c){var d,e,f=a.nodeType;if(a&&3!==f&&8!==f&&2!==f)return"undefined"===typeof a.getAttribute?h.prop(a,b,c):(1===f&&h.isXMLDoc(a)||(b=b.toLowerCase(),d=h.attrHooks[b]||(h.expr.match.bool.test(b)?kc:ia)),void 0===c?d&&"get"in d&&null!==(e=d.get(a,b))?e:(e=h.find.attr(a,b),null==e?void 0:e):null!==c?d&&"set"in d&&void 0!==(e=d.set(a,c,b))?e:(a.setAttribute(b,c+""),c):void h.removeAttr(a,b))},removeAttr:function(a,
b){var c=0,d=b&&b.match(da);if(d&&1===a.nodeType)for(;b=d[c++];){var e=h.propFix[b]||b;h.expr.match.bool.test(b)?Ia&&na||!Va.test(b)?a[e]=!1:a[h.camelCase("default-"+b)]=a[e]=!1:h.attr(a,b,"");a.removeAttribute(na?b:e)}},attrHooks:{type:{set:function(a,b){if(!v.radioValue&&"radio"===b&&h.nodeName(a,"input")){var c=a.value;return a.setAttribute("type",b),c&&(a.value=c),b}}}}});var kc={set:function(a,b,c){return!1===b?h.removeAttr(a,c):Ia&&na||!Va.test(c)?a.setAttribute(!na&&h.propFix[c]||c,c):a[h.camelCase("default-"+
c)]=a[c]=!0,c}};h.each(h.expr.match.bool.source.match(/\w+/g),function(a,b){var c=Z[b]||h.find.attr;Z[b]=Ia&&na||!Va.test(b)?function(a,b,d){var e,f;return d||(f=Z[b],Z[b]=e,e=null!=c(a,b,d)?b.toLowerCase():null,Z[b]=f),e}:function(a,b,c){return c?void 0:a[h.camelCase("default-"+b)]?b.toLowerCase():null}});Ia&&na||(h.attrHooks.value={set:function(a,b,c){return h.nodeName(a,"input")?void(a.defaultValue=b):ia&&ia.set(a,b,c)}});na||(ia={set:function(a,b,c){var d=a.getAttributeNode(c);return d||a.setAttributeNode(d=
a.ownerDocument.createAttribute(c)),d.value=b+="","value"===c||b===a.getAttribute(c)?b:void 0}},Z.id=Z.name=Z.coords=function(a,b,c){var d;return c?void 0:(d=a.getAttributeNode(b))&&""!==d.value?d.value:null},h.valHooks.button={get:function(a,b){return(a=a.getAttributeNode(b))&&a.specified?a.value:void 0},set:ia.set},h.attrHooks.contenteditable={set:function(a,b,c){ia.set(a,""===b?!1:b,c)}},h.each(["width","height"],function(a,b){h.attrHooks[b]={set:function(a,c){return""===c?(a.setAttribute(b,"auto"),
c):void 0}}}));v.style||(h.attrHooks.style={get:function(a){return a.style.cssText||void 0},set:function(a,b){return a.style.cssText=b+""}});var lc=/^(?:input|select|textarea|button|object)$/i,mc=/^(?:a|area)$/i;h.fn.extend({prop:function(a,b){return ca(this,h.prop,a,b,1<arguments.length)},removeProp:function(a){return a=h.propFix[a]||a,this.each(function(){try{this[a]=void 0,delete this[a]}catch(p){}})}});h.extend({propFix:{"for":"htmlFor","class":"className"},prop:function(a,b,c){var d,e,f,g=a.nodeType;
if(a&&3!==g&&8!==g&&2!==g)return f=1!==g||!h.isXMLDoc(a),f&&(b=h.propFix[b]||b,e=h.propHooks[b]),void 0!==c?e&&"set"in e&&void 0!==(d=e.set(a,c,b))?d:a[b]=c:e&&"get"in e&&null!==(d=e.get(a,b))?d:a[b]},propHooks:{tabIndex:{get:function(a){var b=h.find.attr(a,"tabindex");return b?parseInt(b,10):lc.test(a.nodeName)||mc.test(a.nodeName)&&a.href?0:-1}}}});v.hrefNormalized||h.each(["href","src"],function(a,b){h.propHooks[b]={get:function(a){return a.getAttribute(b,4)}}});v.optSelected||(h.propHooks.selected=
{get:function(a){a=a.parentNode;return a&&(a.selectedIndex,a.parentNode&&a.parentNode.selectedIndex),null}});h.each("tabIndex readOnly maxLength cellSpacing cellPadding rowSpan colSpan useMap frameBorder contentEditable".split(" "),function(){h.propFix[this.toLowerCase()]=this});v.enctype||(h.propFix.enctype="encoding");var Wa=/[\t\r\n\f]/g;h.fn.extend({addClass:function(a){var b,c,d,e,f=0,g=this.length;var k="string"==typeof a&&a;if(h.isFunction(a))return this.each(function(b){h(this).addClass(a.call(this,
b,this.className))});if(k)for(k=(a||"").match(da)||[];g>f;f++)if(b=this[f],c=1===b.nodeType&&(b.className?(" "+b.className+" ").replace(Wa," "):" ")){for(e=0;d=k[e++];)0>c.indexOf(" "+d+" ")&&(c+=d+" ");c=h.trim(c);b.className!==c&&(b.className=c)}return this},removeClass:function(a){var b,c,d,e,f=0,g=this.length;var k=0===arguments.length||"string"==typeof a&&a;if(h.isFunction(a))return this.each(function(b){h(this).removeClass(a.call(this,b,this.className))});if(k)for(k=(a||"").match(da)||[];g>
f;f++)if(b=this[f],c=1===b.nodeType&&(b.className?(" "+b.className+" ").replace(Wa," "):"")){for(e=0;d=k[e++];)for(;0<=c.indexOf(" "+d+" ");)c=c.replace(" "+d+" "," ");c=a?h.trim(c):"";b.className!==c&&(b.className=c)}return this},toggleClass:function(a,b){var c=typeof a;return"boolean"==typeof b&&"string"===c?b?this.addClass(a):this.removeClass(a):this.each(h.isFunction(a)?function(c){h(this).toggleClass(a.call(this,c,this.className,b),b)}:function(){if("string"===c)for(var b,d=0,e=h(this),f=a.match(da)||
...
function(a,b){h.fn[b]=function(a,c){return 0<arguments.length?this.on(b,null,a,c):this.trigger(b)}});h.fn.extend({hover:function(a,b){return this.mouseenter(a).mouseleave(b||a)},bind:function(a,b,c){return this.on(a,null,b,c)},unbind:function(a,b){return this.off(a,null,b)},delegate:function(a,b,c,d){return this.on(b,a,c,d)},undelegate:function(a,b,c){return 1===arguments.length?this.off(a,"**"):this.off(b,a||"**",c)}});var Xa=h.now(),Ya=/\?/,nc=/(,)|(\[|{)|(}|])|"(?:[^"\\\r\n]|\\["\\\/bfnrt]|\\u[\da-fA-F]{4})*"\s*:?|true|false|null|-?(?!0\d)\d+(?:\.\d+|)(?:[eE][+-]?\d+|)/g;
h.parseJSON=function(b){if(a.JSON&&a.JSON.parse)return a.JSON.parse(b+"");var c,d=null,e=h.trim(b+"");return e&&!h.trim(e.replace(nc,function(a,b,e,f){return c&&b&&(d=0),0===d?a:(c=e||b,d+=!f-!e,"")}))?Function("return "+e)():h.error("Invalid JSON: "+b)};h.parseXML=function(b){var c,d;if(!b||"string"!=typeof b)return null;try{a.DOMParser?(d=new DOMParser,c=d.parseFromString(b,"text/xml")):(c=new ActiveXObject("Microsoft.XMLDOM"),c.async="false",c.loadXML(b))}catch(H){c=void 0}return c&&c.documentElement&&
!c.getElementsByTagName("parsererror").length||h.error("Invalid XML: "+b),c};var oc=/#.*$/,vb=/([?&])_=[^&]*/,pc=/^(.*?):[ \t]*([^\r\n]*)\r?$/gm,qc=/^(?:GET|HEAD)$/,rc=/^\/\//,wb=/^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/,xb={},Na={},yb="*/".concat("*");try{var oa=location.href}catch(k){oa=C.createElement("a"),oa.href="",oa=oa.href}var wa=wb.exec(oa.toLowerCase())||[];h.extend({active:0,lastModified:{},etag:{},ajaxSettings:{url:oa,type:"GET",isLocal:/^(?:about|app|app-storage|.+-extension|file|res|widget):$/.test(wa[1]),
...
h.ajaxSettings),b):Oa(h.ajaxSettings,a)},ajaxPrefilter:Da(xb),ajaxTransport:Da(Na),ajax:function(a,b){function c(a,b,c,d){var e,m,w,U=b;if(2!==E){E=2;g&&clearTimeout(g);k=void 0;f=d||"";t.readyState=0<a?4:0;d=200<=a&&300>a||304===a;if(c){var r=n;for(var L=t,x,u,H,B,K=r.contents,v=r.dataTypes;"*"===v[0];)v.shift(),void 0===u&&(u=r.mimeType||L.getResponseHeader("Content-Type"));if(u)for(B in K)if(K[B]&&K[B].test(u)){v.unshift(B);break}if(v[0]in c)H=v[0];else{for(B in c){if(!v[0]||r.converters[B+" "+
v[0]]){H=B;break}x||(x=B)}H=H||x}r=H?(H!==v[0]&&v.unshift(H),c[H]):void 0}a:{c=n;x=r;u=t;H=d;var G,R,A;r={};L=c.dataTypes.slice();if(L[1])for(G in c.converters)r[G.toLowerCase()]=c.converters[G];for(B=L.shift();B;)if(c.responseFields[B]&&(u[c.responseFields[B]]=x),!A&&H&&c.dataFilter&&(x=c.dataFilter(x,c.dataType)),A=B,B=L.shift())if("*"===B)B=A;else if("*"!==A&&A!==B){if(G=r[A+" "+B]||r["* "+B],!G)for(y in r)if(R=y.split(" "),R[1]===B&&(G=r[A+" "+R[0]]||r["* "+R[0]])){!0===G?G=r[y]:!0!==r[y]&&(B=
R[0],L.unshift(R[1]));break}if(!0!==G)if(G&&c["throws"])x=G(x);else try{x=G(x)}catch(Qb){var y={state:"parsererror",error:G?Qb:"No conversion from "+A+" to "+B};break a}}y={state:"success",data:x}}r=y;d?(n.ifModified&&(w=t.getResponseHeader("Last-Modified"),w&&(h.lastModified[D]=w),w=t.getResponseHeader("etag"),w&&(h.etag[D]=w)),204===a||"HEAD"===n.type?U="nocontent":304===a?U="notmodified":(U=r.state,e=r.data,m=r.error,d=!m)):(m=U,(a||!U)&&(U="error",0>a&&(a=0)));t.status=a;t.statusText=(b||U)+"";
d?F.resolveWith(z,[e,U,t]):F.rejectWith(z,[t,U,m]);t.statusCode(I);I=void 0;l&&p.trigger(d?"ajaxSuccess":"ajaxError",[t,n,d?e:m]);q.fireWith(z,[t,U]);l&&(p.trigger("ajaxComplete",[t,n]),--h.active||h.event.trigger("ajaxStop"))}}"object"==typeof a&&(b=a,a=void 0);b=b||{};var d,e,f,g,l,k,m,n=h.ajaxSetup({},b),z=n.context||n,p=n.context&&(z.nodeType||z.jquery)?h(z):h.event,F=h.Deferred(),q=h.Callbacks("once memory"),I=n.statusCode||{},U={},r={},E=0,L="canceled",t={readyState:0,getResponseHeader:function(a){var b;
if(2===E){if(!m)for(m={};b=pc.exec(f);)m[b[1].toLowerCase()]=b[2];b=m[a.toLowerCase()]}return null==b?null:b},getAllResponseHeaders:function(){return 2===E?f:null},setRequestHeader:function(a,b){var c=a.toLowerCase();return E||(a=r[c]=r[c]||a,U[a]=b),this},overrideMimeType:function(a){return E||(n.mimeType=a),this},statusCode:function(a){var b;if(a)if(2>E)for(b in a)I[b]=[I[b],a[b]];else t.always(a[t.status]);return this},abort:function(a){a=a||L;return k&&k.abort(a),c(0,a),this}};if(F.promise(t).complete=
q.add,t.success=t.done,t.error=t.fail,n.url=((a||n.url||oa)+"").replace(oc,"").replace(rc,wa[1]+"//"),n.type=b.method||b.type||n.method||n.type,n.dataTypes=h.trim(n.dataType||"*").toLowerCase().match(da)||[""],null==n.crossDomain&&(d=wb.exec(n.url.toLowerCase()),n.crossDomain=!(!d||d[1]===wa[1]&&d[2]===wa[2]&&(d[3]||("http:"===d[1]?"80":"443"))===(wa[3]||("http:"===wa[1]?"80":"443")))),n.data&&n.processData&&"string"!=typeof n.data&&(n.data=h.param(n.data,n.traditional)),db(xb,n,b,t),2===E)return t;
(l=n.global)&&0===h.active++&&h.event.trigger("ajaxStart");n.type=n.type.toUpperCase();n.hasContent=!qc.test(n.type);var D=n.url;n.hasContent||(n.data&&(D=n.url+=(Ya.test(D)?"&":"?")+n.data,delete n.data),!1===n.cache&&(n.url=vb.test(D)?D.replace(vb,"$1_="+Xa++):D+(Ya.test(D)?"&":"?")+"_="+Xa++));n.ifModified&&(h.lastModified[D]&&t.setRequestHeader("If-Modified-Since",h.lastModified[D]),h.etag[D]&&t.setRequestHeader("If-None-Match",h.etag[D]));(n.data&&n.hasContent&&!1!==n.contentType||b.contentType)&&
t.setRequestHeader("Content-Type",n.contentType);t.setRequestHeader("Accept",n.dataTypes[0]&&n.accepts[n.dataTypes[0]]?n.accepts[n.dataTypes[0]]+("*"!==n.dataTypes[0]?", "+yb+"; q=0.01":""):n.accepts["*"]);for(e in n.headers)t.setRequestHeader(e,n.headers[e]);if(n.beforeSend&&(!1===n.beforeSend.call(z,t,n)||2===E))return t.abort();L="abort";for(e in{success:1,error:1,complete:1})t[e](n[e]);if(k=db(Na,n,b,t)){t.readyState=1;l&&p.trigger("ajaxSend",[t,n]);n.async&&0<n.timeout&&(g=setTimeout(function(){t.abort("timeout")},
n.timeout));try{E=1,k.send(U,c)}catch(ib){if(!(2>E))throw ib;c(-1,ib)}}else c(-1,"No Transport");return t},getJSON:function(a,b,c){return h.get(a,b,c,"json")},getScript:function(a,b){return h.get(a,void 0,b,"script")}});h.each(["get","post"],function(a,b){h[b]=function(a,c,d,e){return h.isFunction(c)&&(e=e||d,d=c,c=void 0),h.ajax({url:a,type:b,dataType:e,data:c,success:d})}});h.each("ajaxStart ajaxStop ajaxComplete ajaxError ajaxSuccess ajaxSend".split(" "),function(a,b){h.fn[b]=function(a){return this.on(b,
...
h.css(a,"display"))};h.expr.filters.visible=function(a){return!h.expr.filters.hidden(a)};var sc=/%20/g,Jb=/\[\]$/,zb=/\r?\n/g,tc=/^(?:submit|button|image|reset|file)$/i,uc=/^(?:input|select|textarea|keygen)/i;h.param=function(a,b){var c,d=[],e=function(a,b){b=h.isFunction(b)?b():null==b?"":b;d[d.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};if(void 0===b&&(b=h.ajaxSettings&&h.ajaxSettings.traditional),h.isArray(a)||a.jquery&&!h.isPlainObject(a))h.each(a,function(){e(this.name,this.value)});
else for(c in a)Pa(c,a[c],b,e);return d.join("&").replace(sc,"+")};h.fn.extend({serialize:function(){return h.param(this.serializeArray())},serializeArray:function(){return this.map(function(){var a=h.prop(this,"elements");return a?h.makeArray(a):this}).filter(function(){var a=this.type;return this.name&&!h(this).is(":disabled")&&uc.test(this.nodeName)&&!tc.test(a)&&(this.checked||!La.test(a))}).map(function(a,b){a=h(this).val();return null==a?null:h.isArray(a)?h.map(a,function(a){return{name:b.name,
value:a.replace(zb,"\r\n")}}):{name:b.name,value:a.replace(zb,"\r\n")}}).get()}});h.ajaxSettings.xhr=void 0!==a.ActiveXObject?function(){var b;if(!(b=!this.isLocal&&/^(get|post|head|put|delete|options)$/i.test(this.type)&&eb()))a:{try{b=new a.ActiveXObject("Microsoft.XMLHTTP");break a}catch(p){}b=void 0}return b}:eb;var vc=0,Ja={},Ka=h.ajaxSettings.xhr();a.ActiveXObject&&h(a).on("unload",function(){for(var a in Ja)Ja[a](void 0,!0)});v.cors=!!Ka&&"withCredentials"in Ka;(Ka=v.ajax=!!Ka)&&h.ajaxTransport(function(a){if(!a.crossDomain||
v.cors){var b;return{send:function(c,d){var e,f=a.xhr(),g=++vc;if(f.open(a.type,a.url,a.async,a.username,a.password),a.xhrFields)for(e in a.xhrFields)f[e]=a.xhrFields[e];a.mimeType&&f.overrideMimeType&&f.overrideMimeType(a.mimeType);a.crossDomain||c["X-Requested-With"]||(c["X-Requested-With"]="XMLHttpRequest");for(e in c)void 0!==c[e]&&f.setRequestHeader(e,c[e]+"");f.send(a.hasContent&&a.data||null);b=function(c,e){if(b&&(e||4===f.readyState))if(delete Ja[g],b=void 0,f.onreadystatechange=h.noop,e)4!==
f.readyState&&f.abort();else{var l={};var k=f.status;"string"==typeof f.responseText&&(l.text=f.responseText);try{var m=f.statusText}catch(Ib){m=""}k||!a.isLocal||a.crossDomain?1223===k&&(k=204):k=l.text?200:404}l&&d(k,m,l,f.getAllResponseHeaders())};a.async?4===f.readyState?setTimeout(b):f.onreadystatechange=Ja[g]=b:b()},abort:function(){b&&b(void 0,!0)}}}});h.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},contents:{script:/(?:java|ecma)script/},
...
(b.onload=b.onreadystatechange=null,b.parentNode&&b.parentNode.removeChild(b),b=null,c||e(200,"success"))};c.insertBefore(b,c.firstChild)},abort:function(){b&&b.onload(void 0,!0)}}}});var Ab=[],Za=/(=)\?(?=&|$)|\?\?/;h.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var a=Ab.pop()||h.expando+"_"+Xa++;return this[a]=!0,a}});h.ajaxPrefilter("json jsonp",function(b,c,d){var e,f,g,l=!1!==b.jsonp&&(Za.test(b.url)?"url":"string"==typeof b.data&&!(b.contentType||"").indexOf("application/x-www-form-urlencoded")&&
Za.test(b.data)&&"data");return l||"jsonp"===b.dataTypes[0]?(e=b.jsonpCallback=h.isFunction(b.jsonpCallback)?b.jsonpCallback():b.jsonpCallback,l?b[l]=b[l].replace(Za,"$1"+e):!1!==b.jsonp&&(b.url+=(Ya.test(b.url)?"&":"?")+b.jsonp+"="+e),b.converters["script json"]=function(){return g||h.error(e+" was not called"),g[0]},b.dataTypes[0]="json",f=a[e],a[e]=function(){g=arguments},d.always(function(){a[e]=f;b[e]&&(b.jsonpCallback=c.jsonpCallback,Ab.push(e));g&&h.isFunction(f)&&f(g[0]);g=f=void 0}),"script"):
void 0});h.parseHTML=function(a,b,c){if(!a||"string"!=typeof a)return null;"boolean"==typeof b&&(c=b,b=!1);b=b||C;var d=kb.exec(a);c=!c&&[];return d?[b.createElement(d[1])]:(d=h.buildFragment([a],b,c),c&&c.length&&h(c).remove(),h.merge([],d.childNodes))};var Bb=h.fn.load;h.fn.load=function(a,b,c){if("string"!=typeof a&&Bb)return Bb.apply(this,arguments);var d,e,f,g=this,l=a.indexOf(" ");return 0<=l&&(d=h.trim(a.slice(l,a.length)),a=a.slice(0,l)),h.isFunction(b)?(c=b,b=void 0):b&&"object"==typeof b&&
(f="POST"),0<g.length&&h.ajax({url:a,type:f,dataType:"html",data:b}).done(function(a){e=arguments;g.html(d?h("<div>").append(h.parseHTML(a)).find(d):a)}).complete(c&&function(a,b){g.each(c,e||[a.responseText,b,a])}),this};h.expr.filters.animated=function(a){return h.grep(h.timers,function(b){return a===b.elem}).length};var Cb=a.document.documentElement;h.offset={setOffset:function(a,b,c){var d,e,f,g=h.css(a,"position"),l=h(a),k={};"static"===g&&(a.style.position="relative");var m=l.offset();var n=
...
if(f)return b=f.documentElement,h.contains(b,e)?("undefined"!==typeof e.getBoundingClientRect&&(d=e.getBoundingClientRect()),c=fb(f),{top:d.top+(c.pageYOffset||b.scrollTop)-(b.clientTop||0),left:d.left+(c.pageXOffset||b.scrollLeft)-(b.clientLeft||0)}):d},position:function(){if(this[0]){var a,b,c={top:0,left:0},d=this[0];return"fixed"===h.css(d,"position")?b=d.getBoundingClientRect():(a=this.offsetParent(),b=this.offset(),h.nodeName(a[0],"html")||(c=a.offset()),c.top+=h.css(a[0],"borderTopWidth",!0),
c.left+=h.css(a[0],"borderLeftWidth",!0)),{top:b.top-c.top-h.css(d,"marginTop",!0),left:b.left-c.left-h.css(d,"marginLeft",!0)}}},offsetParent:function(){return this.map(function(){for(var a=this.offsetParent||Cb;a&&!h.nodeName(a,"html")&&"static"===h.css(a,"position");)a=a.offsetParent;return a||Cb})}});h.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(a,b){var c=/Y/.test(b);h.fn[a]=function(d){return ca(this,function(a,d,e){var f=fb(a);return void 0===e?f?b in f?f[b]:f.document.documentElement[d]:
a[d]:void(f?f.scrollTo(c?h(f).scrollLeft():e,c?e:h(f).scrollTop()):a[d]=e)},a,d,arguments.length,null)}});h.each(["top","left"],function(a,b){h.cssHooks[b]=U(v.pixelPosition,function(a,c){return c?(c=fa(a,b),Ba.test(c)?h(a).position()[b]+"px":c):void 0})});h.each({Height:"height",Width:"width"},function(a,b){h.each({padding:"inner"+a,content:b,"":"outer"+a},function(c,d){h.fn[d]=function(d,e){var f=arguments.length&&(c||"boolean"!=typeof d),g=c||(!0===d||!0===e?"margin":"border");return ca(this,function(b,
c,d){var e;return h.isWindow(b)?b.document.documentElement["client"+a]:9===b.nodeType?(e=b.documentElement,Math.max(b.body["scroll"+a],e["scroll"+a],b.body["offset"+a],e["offset"+a],e["client"+a])):void 0===d?h.css(b,c,g):h.style(b,c,d,g)},b,f?d:void 0,f,null)}})});h.fn.size=function(){return this.length};h.fn.andSelf=h.fn.addBack;"function"==typeof define&&define.amd&&define("jquery",[],function(){return h});var wc=a.jQuery,xc=a.$;return h.noConflict=function(b){return a.$===h&&(a.$=xc),b&&a.jQuery===
h&&(a.jQuery=wc),h},"undefined"===typeof b&&(a.jQuery=a.$=h),h});/*
...
this.cycle(!0)),this.interval=clearInterval(this.interval),this};c.prototype.next=function(){return this.sliding?void 0:this.slide("next")};c.prototype.prev=function(){return this.sliding?void 0:this.slide("prev")};c.prototype.slide=function(b,e){var d=this.$element.find(".item.active"),f=e||this.getItemForDirection(b,d);e=this.interval;var g="next"==b?"left":"right",q=this;if(f.hasClass("active"))return this.sliding=!1;var r=f[0],x=a.Event("slide.bs.carousel",{relatedTarget:r,direction:g});if(this.$element.trigger(x),
!x.isDefaultPrevented()){if(this.sliding=!0,e&&this.pause(),this.$indicators.length)this.$indicators.find(".active").removeClass("active"),(x=a(this.$indicators.children()[this.getItemIndex(f)]))&&x.addClass("active");var E=a.Event("slid.bs.carousel",{relatedTarget:r,direction:g});return a.support.transition&&this.$element.hasClass("slide")?(f.addClass(b),f[0].offsetWidth,d.addClass(g),f.addClass(g),d.one("bsTransitionEnd",function(){f.removeClass([b,g].join(" ")).addClass("active");d.removeClass(["active",
g].join(" "));q.sliding=!1;setTimeout(function(){q.$element.trigger(E)},0)}).emulateTransitionEnd(c.TRANSITION_DURATION)):(d.removeClass("active"),f.addClass("active"),this.sliding=!1,this.$element.trigger(E)),e&&this.cycle(),this}};var g=a.fn.carousel;a.fn.carousel=b;a.fn.carousel.Constructor=c;a.fn.carousel.noConflict=function(){return a.fn.carousel=g,this};var e=function(c){var d,e=a(this),g=a(e.attr("data-target")||(d=e.attr("href"))&&d.replace(/.*(?=#[^\s]+$)/,""));g.hasClass("carousel")&&(d=
...
a(this);b=b.data("target")||b.attr("href");var d=/^#./.test(b)&&a(b);return d&&d.length&&d.is(":visible")&&[[d[c]().top+f,b]]||null}).sort(function(a,b){return a[0]-b[0]}).each(function(){b.offsets.push(this[0]);b.targets.push(this[1])})};b.prototype.process=function(){var a,b=this.$scrollElement.scrollTop()+this.options.offset,c=this.getScrollHeight(),g=this.options.offset+c-this.$scrollElement.height(),m=this.offsets,n=this.targets,q=this.activeTarget;if(this.scrollHeight!=c&&this.refresh(),b>=
g)return q!=(a=n[n.length-1])&&this.activate(a);if(q&&b<m[0])return this.activeTarget=null,this.clear();for(a=m.length;a--;)q!=n[a]&&b>=m[a]&&(void 0===m[a+1]||b<m[a+1])&&this.activate(n[a])};b.prototype.activate=function(b){this.activeTarget=b;this.clear();b=a(this.selector+'[data-target="'+b+'"],'+this.selector+'[href="'+b+'"]').parents("li").addClass("active");b.parent(".dropdown-menu").length&&(b=b.closest("li.dropdown").addClass("active"));b.trigger("activate.bs.scrollspy")};b.prototype.clear=
...
a||{})}})(document,jQuery);(function(a){function b(a,b){return a.getAttribute("data-"+b)}function c(a){window.addEventListener&&window.addEventListener("message",function(b){a.id===b.data.sender&&(a.height=b.data.height)},!1)}function g(d,g){g=g||m;if(!g){var l=b(d,"theme")||r||"default";g=e+"cards/"+l+".html"}var E=b(d,"user");l=b(d,"repo");var x=b(d,"github");x&&(x=x.split("/"),x.length&&!E&&(E=x[0],l=l||x[1]));if(E){f+=1;x=b(d,"width");var L=b(d,"height"),D=b(d,"target"),t=b(d,"client-id")||n,z=b(d,"client-secret")||q,F=
"ghcard-"+E+"-"+f,I=a.createElement("iframe");I.setAttribute("id",F);I.setAttribute("frameborder",0);I.setAttribute("scrolling",0);I.setAttribute("allowtransparency",!0);g=g+"?user="+E+"&identity="+F;l&&(g+="&repo="+l);D&&(g+="&target="+D);t&&z&&(g+="&client_id="+t+"&client_secret="+z);I.src=g;I.width=x||Math.min(d.parentNode.clientWidth||400,400);L&&(I.height=L);c(I);d.parentNode.replaceChild(I,d);return I}}var e="//cdn.jsdelivr.net/github-cards/1.0.2/",d,f=0,l=a.getElementsByTagName("meta"),m,n,
q,r;for(d=0;d<l.length;d++){var x=l[d].getAttribute("name"),E=l[d].getAttribute("content");"gc:url"===x?m=E:"gc:base"===x?e=E:"gc:client-id"===x?n=E:"gc:client-secret"===x?q=E:"gc:theme"===x&&(r=E)}l=function(b){if(a.querySelectorAll)return a.querySelectorAll("."+b);var c=a.getElementsByTagName("div"),e=[];for(d=0;d<c.length;d++)~c[d].className.split(" ").indexOf(b)&&e.push(c[d]);return e}("github-card");for(d=0;d<l.length;d++)g(l[d]);window.githubCard&&(window.githubCard.render=g)})(document);/*
...
1),!1});this.$lightbox.find(".lb-loader, .lb-close").on("click",function(){return b.end(),!1})},b.prototype.start=function(b){function c(a){e.album.push({link:a.attr("href"),title:a.attr("data-title")||a.attr("title")})}var e=this,g=a(window);g.on("resize",a.proxy(this.sizeOverlay,this));a("select, object, embed").css({visibility:"hidden"});this.sizeOverlay();this.album=[];var m,n=0;if(m=b.attr("data-lightbox")){m=a(b.prop("tagName")+'[data-lightbox="'+m+'"]');for(var q=0;q<m.length;q=++q)c(a(m[q])),
m[q]===b[0]&&(n=q)}else if("lightbox"===b.attr("rel"))c(b);else for(m=a(b.prop("tagName")+'[rel="'+b.attr("rel")+'"]'),q=0;q<m.length;q=++q)c(a(m[q])),m[q]===b[0]&&(n=q);b=g.scrollTop()+this.options.positionFromTop;g=g.scrollLeft();this.$lightbox.css({top:b+"px",left:g+"px"}).fadeIn(this.options.fadeDuration);this.changeImage(n)},b.prototype.changeImage=function(b){var c=this;this.disableKeyboardNav();var e=this.$lightbox.find(".lb-image");this.$overlay.fadeIn(this.options.fadeDuration);a(".lb-loader").fadeIn("slow");
this.$lightbox.find(".lb-image, .lb-nav, .lb-prev, .lb-next, .lb-dataContainer, .lb-numbers, .lb-caption").hide();this.$outerContainer.addClass("animating");var g=new Image;g.onload=function(){var d,f,l,r,x,E;e.attr("src",c.album[b].link);a(g);e.width(g.width);e.height(g.height);c.options.fitImagesInViewport&&(E=a(window).width(),x=a(window).height(),r=E-c.containerLeftPadding-c.containerRightPadding-20,l=x-c.containerTopPadding-c.containerBottomPadding-120,(g.width>r||g.height>l)&&(g.width/r>g.height/
l?(f=r,d=parseInt(g.height/(g.width/f),10),e.width(f),e.height(d)):(d=l,f=parseInt(g.width/(g.height/d),10),e.width(f),e.height(d))));c.sizeContainer(e.width(),e.height())};g.src=this.album[b].link;this.currentImageIndex=b},b.prototype.sizeOverlay=function(){this.$overlay.width(a(window).width()).height(a(document).height())},b.prototype.sizeContainer=function(a,b){function c(){d.$lightbox.find(".lb-dataContainer").width(q);d.$lightbox.find(".lb-prevLink").height(r);d.$lightbox.find(".lb-nextLink").height(r);
d.showImage()}var d=this,e=this.$outerContainer.outerWidth(),g=this.$outerContainer.outerHeight(),q=a+this.containerLeftPadding+this.containerRightPadding,r=b+this.containerTopPadding+this.containerBottomPadding;e!==q||g!==r?this.$outerContainer.animate({width:q,height:r},this.options.resizeDuration,"swing",function(){c()}):c()},b.prototype.showImage=function(){this.$lightbox.find(".lb-loader").hide();this.$lightbox.find(".lb-image").fadeIn("slow");this.updateNav();this.updateDetails();this.preloadNeighboringImages();
...
b=0;var e=c.attr("original-error"),g;b=$(c).find("iframe.mail-list-form");c.find(".form-error, .form-success").remove();d.attr("data-text",d.text());c.append('<div class="form-error" style="display: none;">'+c.attr("data-error")+"</div>");c.append('<div class="form-success" style="display: none;">'+c.attr("data-success")+"</div>");var q=c.find(".form-error");var r=c.find(".form-success");c.addClass("attempted-submit");if(b.length&&"undefined"!==typeof b.attr("srcdoc")&&""!==b.attr("srcdoc")){console.log("Mail list form signup detected.");
"undefined"!==typeof e&&!1!==e&&q.html(e);e=$(c).find(".signup-email-field").val();var x=$(c).find(".signup-name-field").val();var E=$(c).find("input.signup-first-name-field").length?$(c).find("input.signup-first-name-field").val():$(c).find(".signup-name-field").val();var L=$(c).find(".signup-last-name-field").val();if(1!==a(c)){b=prepareSignup(b);b.find("#mce-EMAIL, #fieldEmail").val(e);b.find("#mce-LNAME, #fieldLastName").val(L);b.find("#mce-FNAME, #fieldFirstName").val(E);b.find("#mce-NAME, #fieldName").val(x);
c.removeClass("attempted-submit");q.fadeOut(200);d.html(jQuery("<div />").addClass("form-loading")).attr("disabled","disabled");try{$.ajax({url:b.attr("action"),crossDomain:!0,data:b.serialize(),method:"GET",cache:!1,dataType:"json",contentType:"application/json; charset=utf-8",success:function(a){"success"!=a.result&&200!=a.Status?(q.attr("original-error",q.text()),q.html(a.msg).fadeIn(1E3),r.fadeOut(1E3),d.html(d.attr("data-text")).removeAttr("disabled")):(d.html(d.attr("data-text")).removeAttr("disabled"),
g=c.attr("success-redirect"),"undefined"!==typeof g&&!1!==g&&""!==g&&(window.location=g),c.find('input[type="text"]').val(""),c.find("textarea").val(""),r.fadeIn(1E3),q.fadeOut(1E3),setTimeout(function(){r.fadeOut(500)},5E3))}})}catch(D){q.attr("original-error",q.text()),q.html(D.message).fadeIn(1E3),r.fadeOut(1E3),setTimeout(function(){q.fadeOut(500)},5E3),d.html(d.attr("data-text")).removeAttr("disabled")}}else q.fadeIn(1E3),setTimeout(function(){q.fadeOut(500)},5E3)}else console.log("Send email form detected."),
"undefined"!==typeof e&&!1!==e&&q.text(e),b=a(c),1===b?(q.fadeIn(200),setTimeout(function(){q.fadeOut(500)},3E3)):(c.removeClass("attempted-submit"),q.fadeOut(200),d.html(jQuery("<div />").addClass("form-loading")).attr("disabled","disabled"),jQuery.ajax({type:"POST",url:"mail/mail.php",data:c.serialize()+"&url="+window.location.href,success:function(a){d.html(d.attr("data-text")).removeAttr("disabled");$.isNumeric(a)?0<parseInt(a)&&(g=c.attr("success-redirect"),"undefined"!==typeof g&&!1!==g&&""!==
g&&(window.location=g),c.find('input[type="text"]').val(""),c.find("textarea").val(""),c.find(".form-success").fadeIn(1E3),q.fadeOut(1E3),setTimeout(function(){r.fadeOut(500)},5E3)):(q.attr("original-error",q.text()),q.text(a).fadeIn(1E3),r.fadeOut(1E3))},error:function(a,b,c){q.attr("original-error",q.text());q.text(c).fadeIn(1E3);r.fadeOut(1E3);d.html(d.attr("data-text")).removeAttr("disabled")}}));return!1});$(".validate-required, .validate-email").on("blur change",function(){a($(this).closest("form"))});
...
smoothScroll:function(b){b=b||{};var c=a.extend({},a.fn.smoothScroll.defaults,b),e=a.smoothScroll.filterPath(location.pathname);return this.unbind("click.smoothscroll").bind("click.smoothscroll",function(b){var d=a(this),g=c.exclude,m=c.excludeWithin,n=0,q=0,r=!0,x={},E=location.hostname===this.hostname||!this.hostname,L=c.scrollTarget||(a.smoothScroll.filterPath(this.pathname)||e)===e,D=this.hash.replace(/(:|\.)/g,"\\$1");if(c.scrollTarget||E&&L&&D){for(;r&&g.length>n;)d.is(g[n++].replace(/(:|\.)/g,
"\\$1"))&&(r=!1);for(;r&&m.length>q;)d.closest(m[q++]).length&&(r=!1)}else r=!1;r&&(b.preventDefault(),a.extend(x,c,{scrollTarget:c.scrollTarget||D,link:this}),a.smoothScroll(x))}),this}});a.smoothScroll=function(b,g){var c,d,f=0,l="offset",m="scrollTop",n={};var q={};"number"==typeof b?(c=a.fn.smoothScroll.defaults,q=b):(c=a.extend({},a.fn.smoothScroll.defaults,b||{}),c.scrollElement&&(l="position","static"==c.scrollElement.css("position")&&c.scrollElement.css("position","relative")));c=a.extend({link:null},
c);m="left"==c.direction?"scrollLeft":m;c.scrollElement?(d=c.scrollElement,f=d[m]()):d=a("html, body").firstScrollable();c.beforeScroll.call(d,c);q="number"==typeof b?b:g||a(c.scrollTarget)[l]()&&a(c.scrollTarget)[l]()[c.direction]||0;n[m]=q+f+c.offset;b=c.speed;"auto"===b&&(b=n[m]||d.scrollTop(),b/=c.autoCoefficent);q={duration:b,easing:c.easing,complete:function(){c.afterScroll.call(c.link,c)}};c.step&&(q.step=c.step);d.length?d.stop().animate(n,q):c.afterScroll.call(c.link,c)};a.smoothScroll.version=
"1.4.10";a.smoothScroll.filterPath=function(a){return a.replace(/^\//,"").replace(/(index|default).[a-zA-Z]{3,4}$/,"").replace(/\/$/,"")};a.fn.smoothScroll.defaults={exclude:[],excludeWithin:[],offset:0,direction:"top",scrollElement:null,scrollTarget:null,beforeScroll:function(){},afterScroll:function(){},easing:"swing",speed:400,autoCoefficent:2}}(jQuery);(function(a,b){"function"===typeof define&&define.amd?define([],b):"object"===typeof exports?module.exports=b():b()})(this,function(){function a(a){if(null===D){for(var b=a.length,c=0,e=document.getElementById(d),f="<ul>";c<b;)f+="<li>"+a[c]+"</li>",c++;e.innerHTML=f+"</ul>"}else D(a)}function b(a){return a.replace(/<b[^>]*>(.*?)<\/b>/gi,function(a,b){return b}).replace(/class="(?!(tco-hidden|tco-display|tco-ellipsis))+.*?"|data-query-source=".*?"|dir=".*?"|rel=".*?"/gi,"")}function c(a){a=a.getElementsByTagName("a");
for(var b=a.length-1;0<=b;b--)a[b].setAttribute("target","_blank")}function g(a,b){var c=[];b=new RegExp("(^| )"+b+"( |$)");a=a.getElementsByTagName("*");for(var d=0,e=a.length;d<e;d++)b.test(a[d].className)&&c.push(a[d]);return c}function e(a){if(void 0!==a&&0<=a.innerHTML.indexOf("data-srcset"))return a=a.innerHTML.match(/data-srcset="([A-z0-9%_\.-]+)/i)[0],decodeURIComponent(a).split('"')[1]}var d="",f=20,l=!0,m=[],n=!1,q=!0,r=!0,x=null,E=!0,L=!0,D=null,y=!0,T=!1,M=!0,u=!0,Q=!1,t=null,z={fetch:function(a){void 0===
a.maxTweets&&(a.maxTweets=20);void 0===a.enableLinks&&(a.enableLinks=!0);void 0===a.showUser&&(a.showUser=!0);void 0===a.showTime&&(a.showTime=!0);void 0===a.dateFunction&&(a.dateFunction="default");void 0===a.showRetweet&&(a.showRetweet=!0);void 0===a.customCallback&&(a.customCallback=null);void 0===a.showInteraction&&(a.showInteraction=!0);void 0===a.showImages&&(a.showImages=!1);void 0===a.linksInNewWindow&&(a.linksInNewWindow=!0);void 0===a.showPermalinks&&(a.showPermalinks=!0);void 0===a.dataOnly&&
(a.dataOnly=!1);if(n)m.push(a);else{n=!0;d=a.domId;f=a.maxTweets;l=a.enableLinks;r=a.showUser;q=a.showTime;L=a.showRetweet;x=a.dateFunction;D=a.customCallback;y=a.showInteraction;T=a.showImages;M=a.linksInNewWindow;u=a.showPermalinks;Q=a.dataOnly;var b=document.getElementsByTagName("head")[0];null!==t&&b.removeChild(t);t=document.createElement("script");t.type="text/javascript";t.src="https://cdn.syndication.twimg.com/widgets/timelines/"+a.id+"?&lang="+(a.lang||"en")+"&callback=twitterFetcher.callback&suppress_response_codes=true&rnd="+
Math.random();b.appendChild(t)}},callback:function(d){function F(a){var b=a.getElementsByTagName("img")[0];b.src=b.getAttribute("data-src-2x");return a}var t=document.createElement("div");t.innerHTML=d.body;"undefined"===typeof t.getElementsByClassName&&(E=!1);d=[];var D=[],G=[],W=[];var A=[];var ba=[],P=[],N=0;if(E)for(t=t.getElementsByClassName("timeline-Tweet");N<t.length;){0<t[N].getElementsByClassName("timeline-Tweet-retweetCredit").length?A.push(!0):A.push(!1);if(!A[N]||A[N]&&L)d.push(t[N].getElementsByClassName("timeline-Tweet-text")[0]),
ba.push(t[N].getAttribute("data-tweet-id")),D.push(F(t[N].getElementsByClassName("timeline-Tweet-author")[0])),G.push(t[N].getElementsByClassName("dt-updated")[0]),P.push(t[N].getElementsByClassName("timeline-Tweet-timestamp")[0]),void 0!==t[N].getElementsByClassName("timeline-Tweet-media")[0]?W.push(t[N].getElementsByClassName("timeline-Tweet-media")[0]):W.push(void 0);N++}else for(t=g(t,"timeline-Tweet");N<t.length;){0<g(t[N],"timeline-Tweet-retweetCredit").length?A.push(!0):A.push(!1);if(!A[N]||
A[N]&&L)d.push(g(t[N],"timeline-Tweet-text")[0]),ba.push(t[N].getAttribute("data-tweet-id")),D.push(F(g(t[N],"timeline-Tweet-author")[0])),G.push(g(t[N],"dt-updated")[0]),P.push(g(t[N],"timeline-Tweet-timestamp")[0]),void 0!==g(t[N],"timeline-Tweet-media")[0]?W.push(g(t[N],"timeline-Tweet-media")[0]):W.push(void 0);N++}d.length>f&&(d.splice(f,d.length-f),D.splice(f,D.length-f),G.splice(f,G.length-f),A.splice(f,A.length-f),W.splice(f,W.length-f),P.splice(f,P.length-f));t=[];N=d.length;var J=0;if(Q)for(;J<
N;)t.push({tweet:d[J].innerHTML,author:D[J].innerHTML,time:G[J].textContent,image:e(W[J]),rt:A[J],tid:ba[J],permalinkURL:void 0===P[J]?"":P[J].href}),J++;else for(;J<N;){if("string"!==typeof x){A=G[J].getAttribute("datetime");var X=new Date(G[J].getAttribute("datetime").replace(/-/g,"/").replace("T"," ").split("+")[0]);A=x(X,A);G[J].setAttribute("aria-label",A);if(d[J].textContent)if(E)G[J].textContent=A;else{X=document.createElement("p");var Ma=document.createTextNode(A);X.appendChild(Ma);X.setAttribute("aria-label",
A);G[J]=X}else G[J].textContent=A}A="";l?(M&&(c(d[J]),r&&c(D[J])),r&&(A+='<div class="user">'+b(D[J].innerHTML)+"</div>"),A+='<p class="tweet">'+b(d[J].innerHTML)+"</p>",q&&(A=u?A+('<p class="timePosted"><a href="'+P[J]+'">'+G[J].getAttribute("aria-label")+"</a></p>"):A+('<p class="timePosted">'+G[J].getAttribute("aria-label")+"</p>"))):(r&&(A+='<p class="user">'+D[J].textContent+"</p>"),A+='<p class="tweet">'+d[J].textContent+"</p>",q&&(A+='<p class="timePosted">'+G[J].textContent+"</p>"));y&&(A+=
'<p class="interact"><a href="https://twitter.com/intent/tweet?in_reply_to='+ba[J]+'" class="twitter_reply_icon"'+(M?' target="_blank">':">")+'Reply</a><a href="https://twitter.com/intent/retweet?tweet_id='+ba[J]+'" class="twitter_retweet_icon"'+(M?' target="_blank">':">")+'Retweet</a><a href="https://twitter.com/intent/favorite?tweet_id='+ba[J]+'" class="twitter_fav_icon"'+(M?' target="_blank">':">")+"Favorite</a></p>");T&&void 0!==W[J]&&(A+='<div class="media"><img src="'+e(W[J])+'" alt="Image from tweet" /></div>');
t.push(A);J++}a(t);n=!1;0<m.length&&(z.fetch(m[0]),m.splice(0,1))}};return window.twitterFetcher=z});var toBase64="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".split(""),fromBase64="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
...
GameBoyCore.prototype.SpriteGBLayerRender=function(a){if(this.gfxSpriteShow){a+=16;var b=1;for(var c,g,e,d,f,l,m=0,n,q,r;168>b;)this.sortBuffer[b++]=255;if(this.gfxSpriteNormalHeight)for(n=this.findLowestSpriteDrawable(a,7);m<n;++m){b=this.OAMAddressCache[m];var x=a-this.memory[b]<<3;e=this.memory[b|3];d=(e&16)>>2;f=this.tileCache[(e&96)<<4|this.memory[b|2]];r=c=this.memory[b|1];g=Math.min(168-r,8);b=7<r?0:8-r;for(q=this.pixelStart+(8<r?r-8:0);b<g;++b,++q,++r)this.sortBuffer[r]>c&&(33554432<=this.frameBuffer[q]?
(l=f[x|b],0<l&&(this.frameBuffer[q]=this.OBJPalette[d|l],this.sortBuffer[r]=c)):16777216>this.frameBuffer[q]&&(l=f[x|b],0<l&&128>e&&(this.frameBuffer[q]=this.OBJPalette[d|l],this.sortBuffer[r]=c)))}else for(n=this.findLowestSpriteDrawable(a,15);m<n;++m)for(b=this.OAMAddressCache[m],x=a-this.memory[b]<<3,e=this.memory[b|3],d=(e&16)>>2,f=(e&64)==(64&x)?this.tileCache[(e&96)<<4|this.memory[b|2]&254]:this.tileCache[(e&96)<<4|this.memory[b|2]|1],x&=63,r=c=this.memory[b|1],g=Math.min(168-r,8),b=7<r?0:8-
r,q=this.pixelStart+(8<r?r-8:0);b<g;++b,++q,++r)this.sortBuffer[r]>c&&(33554432<=this.frameBuffer[q]?(l=f[x|b],0<l&&(this.frameBuffer[q]=this.OBJPalette[d|l],this.sortBuffer[r]=c)):16777216>this.frameBuffer[q]&&(l=f[x|b],0<l&&128>e&&(this.frameBuffer[q]=this.OBJPalette[d|l],this.sortBuffer[r]=c)))}};GameBoyCore.prototype.findLowestSpriteDrawable=function(a,b){for(var c=65024,g=0,e;65184>c&&10>g;)e=a-this.memory[c],(e&b)==e&&(this.OAMAddressCache[g++]=c),c+=4;return g};
GameBoyCore.prototype.SpriteGBCLayerRender=function(a){if(this.gfxSpriteShow){var b=65024;a+=16;var c,g=0;if(this.gfxSpriteNormalHeight)for(;65184>b&&10>g;b+=4){var e=a-this.memory[b];if((e&7)==e){var d=this.memory[b|1]-8;var f=Math.min(160,d+8);var l=this.memory[b|3];var m=(l&7)<<2;var n=this.tileCache[(l&8)<<8|(l&96)<<4|this.memory[b|2]];var q=0<d?d:0;d-=e<<3;for(c=this.pixelStart+q;q<f;++q,++c)33554432<=this.frameBuffer[c]?(e=n[q-d],0<e&&(this.frameBuffer[c]=this.gbcOBJPalette[m|e])):16777216>
this.frameBuffer[c]&&(e=n[q-d],0<e&&128>l&&(this.frameBuffer[c]=this.gbcOBJPalette[m|e]));++g}}else for(;65184>b&&10>g;b+=4)if(e=a-this.memory[b],(e&15)==e){d=this.memory[b|1]-8;f=Math.min(160,d+8);l=this.memory[b|3];m=(l&7)<<2;n=(l&64)==(64&e<<3)?this.tileCache[(l&8)<<8|(l&96)<<4|this.memory[b|2]&254]:this.tileCache[(l&8)<<8|(l&96)<<4|this.memory[b|2]|1];q=0<d?d:0;d-=(e&7)<<3;for(c=this.pixelStart+q;q<f;++q,++c)33554432<=this.frameBuffer[c]?(e=n[q-d],0<e&&(this.frameBuffer[c]=this.gbcOBJPalette[m|
e])):16777216>this.frameBuffer[c]&&(e=n[q-d],0<e&&128>l&&(this.frameBuffer[c]=this.gbcOBJPalette[m|e]));++g}}};GameBoyCore.prototype.generateGBTileLine=function(a){var b=this.memory[1|a]<<8|this.memory[40958&a],c=this.tileCache[(a&8176)>>4];a=(a&14)<<2;c[a|7]=(b&256)>>7|b&1;c[a|6]=(b&512)>>8|(b&2)>>1;c[a|5]=(b&1024)>>9|(b&4)>>2;c[a|4]=(b&2048)>>10|(b&8)>>3;c[a|3]=(b&4096)>>11|(b&16)>>4;c[a|2]=(b&8192)>>12|(b&32)>>5;c[a|1]=(b&16384)>>13|(b&64)>>6;c[a]=(b&32768)>>14|(b&128)>>7};
...
d+=f;var n=[];if("[object Array]"===Object.prototype.toString.apply(l)){var q=l.length;for(a=0;a<q;a+=1)n[a]=c(a,l)||"null";e=0===n.length?"[]":d?"[\n"+d+n.join(",\n"+d)+"\n"+g+"]":"["+n.join(",")+"]";d=g;return e}if(m&&"object"===typeof m)for(q=m.length,a=0;a<q;a+=1){var D=m[a];"string"===typeof D&&(e=c(D,l))&&n.push(b(D)+(d?": ":":")+e)}else for(D in l)Object.hasOwnProperty.call(l,D)&&(e=c(D,l))&&n.push(b(D)+(d?": ":":")+e);e=0===n.length?"{}":d?"{\n"+d+n.join(",\n"+d)+"\n"+g+"}":"{"+n.join(",")+
...
(function(a){function b(a){var b=parseFloat(a);return-1===a.indexOf("%")&&!isNaN(b)&&b}function c(){}function g(c){function f(){if(!r){r=!0;var d=a.getComputedStyle;if(g=function(){var a=d?function(a){return d(a,null)}:function(a){return a.currentStyle};return function(b){b=a(b);return b||e("Style returned "+b+". Are you running this code in a hidden iframe on Firefox? See http://bit.ly/getsizebug1"),b}}(),n=c("boxSizing")){var f=document.createElement("div");f.style.width="200px";f.style.padding=
"1px 2px 3px 4px";f.style.borderStyle="solid";f.style.borderWidth="1px 2px 3px 4px";f.style[n]="border-box";var l=document.body||document.documentElement;l.appendChild(f);var m=g(f);q=200===b(m.width);l.removeChild(f)}}}var g,n,q,r=!1;return function(c){if(f(),"string"==typeof c&&(c=document.querySelector(c)),c&&"object"==typeof c&&c.nodeType){var e=g(c);if("none"===e.display){var l={width:0,height:0,innerWidth:0,innerHeight:0,outerWidth:0,outerHeight:0};e=0;for(var m=d.length;m>e;e++)l[d[e]]=0;return l}l=
{};l.width=c.offsetWidth;l.height=c.offsetHeight;m=l.isBorderBox=!(!n||!e[n]||"border-box"!==e[n]);for(var r=0,x=d.length;x>r;r++){var M=d[r],u=e[M];var Q=c,t=u;if(a.getComputedStyle||-1===t.indexOf("%"))u=t;else{u=Q.style;var z=u.left,F=Q.runtimeStyle,I=F&&F.left;u=(I&&(F.left=Q.currentStyle.left),u.left=t,t=u.pixelLeft,u.left=z,I&&(F.left=I),t)}Q=parseFloat(u);l[M]=isNaN(Q)?0:Q}c=l.paddingLeft+l.paddingRight;r=l.paddingTop+l.paddingBottom;x=l.marginLeft+l.marginRight;M=l.marginTop+l.marginBottom;
Q=l.borderLeftWidth+l.borderRightWidth;t=l.borderTopWidth+l.borderBottomWidth;m=m&&q;u=b(e.width);!1!==u&&(l.width=u+(m?0:c+Q));e=b(e.height);return!1!==e&&(l.height=e+(m?0:r+t)),l.innerWidth=l.width-(c+Q),l.innerHeight=l.height-(r+t),l.outerWidth=l.width+x,l.outerHeight=l.height+M,l}}}var e="undefined"==typeof console?c:function(a){console.error(a)},d="paddingLeft paddingRight paddingTop paddingBottom marginLeft marginRight marginTop marginBottom borderLeftWidth borderRightWidth borderTopWidth borderBottomWidth".split(" ");
...
(function(a){function b(a,b){for(var c in b)a[c]=b[c];return a}function c(a){return a.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()})}function g(a,e,g){function f(a,b){a&&(this.element=a,this.layout=b,this.position={x:0,y:0},this._create())}var l=g("transition"),m=g("transform"),x=l&&m,E=!!g("perspective"),L={WebkitTransition:"webkitTransitionEnd",MozTransition:"transitionend",OTransition:"otransitionend",transition:"transitionend"}[l],D=["transform","transition","transitionDuration","transitionProperty"],
y=function(){for(var a={},b=0,c=D.length;c>b;b++){var d=D[b],e=g(d);e&&e!==d&&(a[d]=e)}return a}();b(f.prototype,a.prototype);f.prototype._create=function(){this._transn={ingProperties:{},clean:{},onEnd:{}};this.css({position:"absolute"})};f.prototype.handleEvent=function(a){var b="on"+a.type;this[b]&&this[b](a)};f.prototype.getSize=function(){this.size=e(this.element)};f.prototype.css=function(a){var b=this.element.style,c;for(c in a)b[y[c]||c]=a[c]};f.prototype.getPosition=function(){var a=d(this.element),
...
(function(a){function b(a,b){for(var c in b)a[c]=b[c];return a}function c(a){var b=[];if("[object Array]"===q.call(a))b=a;else if(a&&"number"==typeof a.length)for(var c=0,d=a.length;d>c;c++)b.push(a[c]);else b.push(a);return b}function g(a,b){a=x(b,a);-1!==a&&b.splice(a,1)}function e(a){return a.replace(/(.)([A-Z])/g,function(a,b,c){return b+"-"+c}).toLowerCase()}function d(d,q,x,y,T,M){function u(a,c){if("string"==typeof a&&(a=f.querySelector(a)),!a||!r(a))return void(l&&l.error("Bad "+this.constructor.namespace+
" element: "+a));this.element=a;this.options=b({},this.constructor.defaults);this.option(c);a=++E;this.element.outlayerGUID=a;t[a]=this;this._create();this.options.isInitLayout&&this.layout()}var E=0,t={};return u.namespace="outlayer",u.Item=M,u.defaults={containerStyle:{position:"relative"},isInitLayout:!0,isOriginLeft:!0,isOriginTop:!0,isResizeBound:!0,isResizingContainer:!0,transitionDuration:"0.4s",hiddenStyle:{opacity:0,transform:"scale(0.001)"},visibleStyle:{opacity:1,transform:"scale(1)"}},
b(u.prototype,x.prototype),u.prototype.option=function(a){b(this.options,a)},u.prototype._create=function(){this.reloadItems();this.stamps=[];this.stamp(this.options.stamp);b(this.element.style,this.options.containerStyle);this.options.isResizeBound&&this.bindResize()},u.prototype.reloadItems=function(){this.items=this._itemize(this.element.children)},u.prototype._itemize=function(a){a=this._filterFindItemElements(a);for(var b=this.constructor.Item,c=[],d=0,e=a.length;e>d;d++){var f=new b(a[d],this);
c.push(f)}return c},u.prototype._filterFindItemElements=function(a){a=c(a);for(var b=this.options.itemSelector,d=[],e=0,f=a.length;f>e;e++){var g=a[e];if(r(g))if(b){T(g,b)&&d.push(g);g=g.querySelectorAll(b);for(var l=0,m=g.length;m>l;l++)d.push(g[l])}else d.push(g)}return d},u.prototype.getItemElements=function(){for(var a=[],b=0,c=this.items.length;c>b;b++)a.push(this.items[b].element);return a},u.prototype.layout=function(){this._resetLayout();this._manageStamps();this.layoutItems(this.items,void 0!==
this.options.isLayoutInstant?this.options.isLayoutInstant:!this._isLayoutInited);this._isLayoutInited=!0},u.prototype._init=u.prototype.layout,u.prototype._resetLayout=function(){this.getSize()},u.prototype.getSize=function(){this.size=y(this.element)},u.prototype._getMeasurement=function(a,b){var c,d=this.options[a];d?("string"==typeof d?c=this.element.querySelector(d):r(d)&&(c=d),this[a]=c?y(c)[b]:d):this[a]=0},u.prototype.layoutItems=function(a,b){a=this._getItemsForLayout(a);this._layoutItems(a,
b);this._postLayout()},u.prototype._getItemsForLayout=function(a){for(var b=[],c=0,d=a.length;d>c;c++){var e=a[c];e.isIgnored||b.push(e)}return b},u.prototype._layoutItems=function(a,b){function c(){d.emitEvent("layoutComplete",[d,a])}var d=this;if(!a||!a.length)return void c();this._itemsOn(a,"layout",c);for(var e=[],f=0,g=a.length;g>f;f++){var l=a[f],m=this._getItemLayoutPosition(l);m.item=l;m.isInstant=b||l.isLayoutInstant;e.push(m)}this._processLayoutQueue(e)},u.prototype._getItemLayoutPosition=
function(){return{x:0,y:0}},u.prototype._processLayoutQueue=function(a){for(var b=0,c=a.length;c>b;b++){var d=a[b];this._positionItem(d.item,d.x,d.y,d.isInstant)}},u.prototype._positionItem=function(a,b,c,d){d?a.goTo(b,c):a.moveTo(b,c)},u.prototype._postLayout=function(){this.resizeContainer()},u.prototype.resizeContainer=function(){if(this.options.isResizingContainer){var a=this._getContainerSize();a&&(this._setContainerMeasure(a.width,!0),this._setContainerMeasure(a.height,!1))}},u.prototype._getContainerSize=
n,u.prototype._setContainerMeasure=function(a,b){if(void 0!==a){var c=this.size;c.isBorderBox&&(a+=b?c.paddingLeft+c.paddingRight+c.borderLeftWidth+c.borderRightWidth:c.paddingBottom+c.paddingTop+c.borderTopWidth+c.borderBottomWidth);a=Math.max(a,0);this.element.style[b?"width":"height"]=a+"px"}},u.prototype._itemsOn=function(a,b,c){function d(){return e++,e===f&&c.call(g),!0}for(var e=0,f=a.length,g=this,l=0,m=a.length;m>l;l++)a[l].on(b,d)},u.prototype.ignore=function(a){(a=this.getItem(a))&&(a.isIgnored=
!0)},u.prototype.unignore=function(a){(a=this.getItem(a))&&delete a.isIgnored},u.prototype.stamp=function(a){if(a=this._find(a)){this.stamps=this.stamps.concat(a);for(var b=0,c=a.length;c>b;b++)this.ignore(a[b])}},u.prototype.unstamp=function(a){if(a=this._find(a))for(var b=0,c=a.length;c>b;b++){var d=a[b];g(d,this.stamps);this.unignore(d)}},u.prototype._find=function(a){return a?("string"==typeof a&&(a=this.element.querySelectorAll(a)),c(a)):void 0},u.prototype._manageStamps=function(){if(this.stamps&&
this.stamps.length){this._getBoundingRect();for(var a=0,b=this.stamps.length;b>a;a++)this._manageStamp(this.stamps[a])}},u.prototype._getBoundingRect=function(){var a=this.element.getBoundingClientRect(),b=this.size;this._boundingRect={left:a.left+b.paddingLeft+b.borderLeftWidth,top:a.top+b.paddingTop+b.borderTopWidth,right:a.right-(b.paddingRight+b.borderRightWidth),bottom:a.bottom-(b.paddingBottom+b.borderBottomWidth)}},u.prototype._manageStamp=n,u.prototype._getElementOffset=function(a){var b=
a.getBoundingClientRect(),c=this._boundingRect;a=y(a);return{left:b.left-c.left-a.marginLeft,top:b.top-c.top-a.marginTop,right:c.right-b.right-a.marginRight,bottom:c.bottom-b.bottom-a.marginBottom}},u.prototype.handleEvent=function(a){var b="on"+a.type;this[b]&&this[b](a)},u.prototype.bindResize=function(){this.isResizeBound||(d.bind(a,"resize",this),this.isResizeBound=!0)},u.prototype.unbindResize=function(){this.isResizeBound&&d.unbind(a,"resize",this);this.isResizeBound=!1},u.prototype.onresize=
function(){this.resizeTimeout&&clearTimeout(this.resizeTimeout);var a=this;this.resizeTimeout=setTimeout(function(){a.resize();delete a.resizeTimeout},100)},u.prototype.resize=function(){this.isResizeBound&&this.needsResizeLayout()&&this.layout()},u.prototype.needsResizeLayout=function(){var a=y(this.element);return this.size&&a&&a.innerWidth!==this.size.innerWidth},u.prototype.addItems=function(a){a=this._itemize(a);return a.length&&(this.items=this.items.concat(a)),a},u.prototype.appended=function(a){a=
this.addItems(a);a.length&&(this.layoutItems(a,!0),this.reveal(a))},u.prototype.prepended=function(a){a=this._itemize(a);if(a.length){var b=this.items.slice(0);this.items=a.concat(b);this._resetLayout();this._manageStamps();this.layoutItems(a,!0);this.reveal(a);this.layoutItems(b)}},u.prototype.reveal=function(a){var b=a&&a.length;if(b)for(var c=0;b>c;c++)a[c].reveal()},u.prototype.hide=function(a){var b=a&&a.length;if(b)for(var c=0;b>c;c++)a[c].hide()},u.prototype.getItem=function(a){for(var b=0,
c=this.items.length;c>b;b++){var d=this.items[b];if(d.element===a)return d}},u.prototype.getItems=function(a){if(a&&a.length){for(var b=[],c=0,d=a.length;d>c;c++){var e=this.getItem(a[c]);e&&b.push(e)}return b}},u.prototype.remove=function(a){a=c(a);var b=this.getItems(a);if(b&&b.length){this._itemsOn(b,"remove",function(){this.emitEvent("removeComplete",[this,b])});a=0;for(var d=b.length;d>a;a++){var e=b[a];e.remove();g(e,this.items)}}},u.prototype.destroy=function(){var a=this.element.style;a.height=
"";a.position="";a.width="";a=0;for(var b=this.items.length;b>a;a++)this.items[a].destroy();this.unbindResize();delete t[this.element.outlayerGUID];delete this.element.outlayerGUID;m&&m.removeData(this.element,this.constructor.namespace)},u.data=function(a){return(a=a&&a.outlayerGUID)&&t[a]},u.create=function(a,c){function d(){u.apply(this,arguments)}return Object.create?d.prototype=Object.create(u.prototype):b(d.prototype,u.prototype),d.prototype.constructor=d,d.defaults=b({},u.defaults),b(d.defaults,
c),d.prototype.settings={},d.namespace=a,d.data=u.data,d.Item=function(){M.apply(this,arguments)},d.Item.prototype=new M,q(function(){var b=e(a),c=f.querySelectorAll(".js-"+b);b="data-"+b+"-options";for(var g=0,n=c.length;n>g;g++){var q=c[g],r=q.getAttribute(b);try{var t=r&&JSON.parse(r)}catch(N){l&&l.error("Error parsing "+b+" on "+q.nodeName.toLowerCase()+(q.id?"#"+q.id:"")+": "+N);continue}r=new d(q,t);m&&m.data(q,a,r)}}),m&&m.bridget&&m.bridget(a,d),d},u.Item=M,u}var f=a.document,l=a.console,
m=a.jQuery,n=function(){},q=Object.prototype.toString,r="function"==typeof HTMLElement||"object"==typeof HTMLElement?function(a){return a instanceof HTMLElement}:function(a){return a&&"object"==typeof a&&1===a.nodeType&&"string"==typeof a.nodeName},x=Array.prototype.indexOf?function(a,b){return a.indexOf(b)}:function(a,b){for(var c=0,d=a.length;d>c;c++)if(a[c]===b)return c;return-1};"function"==typeof define&&define.amd?define("outlayer/outlayer","eventie/eventie doc-ready/doc-ready eventEmitter/EventEmitter get-size/get-size matches-selector/matches-selector ./item".split(" "),
...
this.gutter},a.prototype.needsResizeLayout=function(){var a=this.containerWidth;return this.getContainerWidth(),a!==this.containerWidth},a}var c=Array.prototype.indexOf?function(a,b){return a.indexOf(b)}:function(a,b){for(var c=0,e=a.length;e>c;c++)if(a[c]===b)return c;return-1};"function"==typeof define&&define.amd?define(["outlayer/outlayer","get-size/get-size"],b):"object"==typeof exports?module.exports=b(require("outlayer"),require("get-size")):a.Masonry=b(a.Outlayer,a.getSize)})(window);function mr_parallax(){function a(){var a,b=0;return d()?(b=jQuery(".viu").find("nav:first").outerHeight(!0),a=jQuery(".viu").find("nav:first").css("position"),("absolute"===a||"fixed"===a)&&(b=0)):b=jQuery(document).find("nav:first").outerHeight(!0),b}function b(){if(F){for(var a=f.length,e=c();a--;){var g=f[a],y=e,A=n,I=q;d()?y+r-x>g.elemTop&&y-x<g.elemBottom&&(g.isFirstSection?g.imageHolder.style[m]=A+y/2+I:g.imageHolder.style[m]=A+(y-g.elemTop-x)/2+I):y+r>g.elemTop&&y<g.elemBottom&&(g.isFirstSection?
g.imageHolder.style[m]=A+y/2+I:g.imageHolder.style[m]=A+(y+r-g.elemTop)/2+I)}F=!1}E&&(a=t,e=-D,y=L,A=y-1,g=(A/=Q,y/=Q,A--,y--,M*(y*y*y*y*y+1)+0-(M*(A*A*A*A*A+1)+0)),t=a+e*g,(t>u||-u>t)&&(z.scrollBy(0,t),t=0),L++,L>Q&&(L=0,E=!1,D=0,t=0));l(b)}function c(){return z!=window?z.scrollTop:0===document.documentElement.scrollTop?document.body.scrollTop:document.documentElement.scrollTop}function g(){F=!0}function e(a){!0===I.mr_scrollAssist&&(a.preventDefault&&a.preventDefault(),D=a.notRealWheel?-a.deltaY/
4:1==a.deltaMode?-a.deltaY/3:100===Math.abs(a.deltaY)?-a.deltaY/120:-a.deltaY/40,D=-y>D?-y:D,D=D>y?y:D,E=!0,L=T)}function d(){return"undefined"==typeof window.mr_variant?!1:!0}var f,l=window.requestAnimationFrame||window.mozRequestAnimationFrame||window.webkitRequestAnimationFrame||window.msRequestAnimationFrame,m=function(a){for(var b=0;b<a.length;b++)if("undefined"!=typeof document.body.style[a[b]])return a[b];return null}(["transform","msTransform","webkitTransform","mozTransform","oTransform"]),
n="translate3d(0,",q="px,0)",r=Math.max(document.documentElement.clientHeight,window.innerHeight||0),x=0,E=!1,L=0,D=0,y=2,T=4,M=300,u=1,Q=30,t=0,z=window,F=(d(),!1),I=this;this.mr_scrollAssist=$("body").hasClass("scroll-assist")?!0:!1;jQuery(document).ready(function(){I.documentReady()});jQuery(window).load(function(){I.windowLoad()});this.getScrollingState=function(){return 0<L?!0:!1};this.documentReady=function(a){r=Math.max(document.documentElement.clientHeight,window.innerHeight||0);jQuery("body").hasClass("parallax-2d")&&
(n="translate(0,",q="px)");/Android|iPad|iPhone|iPod|BlackBerry|Windows Phone/i.test(navigator.userAgent||navigator.vendor||window.opera)?jQuery(".parallax").removeClass("parallax"):l&&(I.profileParallaxElements(),I.setupParallax());var b={};return a&&"[object Function]"===b.toString.call(a)?void a():void 0};this.windowLoad=function(){r=Math.max(document.documentElement.clientHeight,window.innerHeight||0);x=a();window.mr_parallax.profileParallaxElements()};this.setupParallax=function(){d()&&(z=jQuery(".viu").get(0),
"undefined"!=typeof z&&(z.scrollBy=function(a,b){this.scrollTop+=b;this.scrollLeft+=a}));"undefined"!=typeof z&&(z.addEventListener("scroll",g,!1),window.addWheelListener(z,e,!1),window.addEventListener("resize",function(){r=Math.max(document.documentElement.clientHeight,window.innerHeight||0);x=a();I.profileParallaxElements()},!1),b())};this.profileParallaxElements=function(){f=[];x=a();var b=d(),e=".parallax > .background-image-holder, .parallax ul.slides > li > .background-image-holder";b&&(e=
".viu .parallax > .background-image-holder, .viu .parallax ul.slides > li > .background-image-holder");jQuery(e).each(function(a){a=jQuery(this).closest(".parallax");var d=b?a.position().top:a.offset().top;f.push({section:a.get(0),outerHeight:a.outerHeight(),elemTop:d,elemBottom:d+a.outerHeight(),isFirstSection:a.is(":nth-of-type(1)")?!0:!1,imageHolder:jQuery(this).get(0)});b?b&&(a.is(":nth-of-type(1)")?I.mr_setTranslate3DTransform(jQuery(this).get(0),0===c()?0:c()/2):I.mr_setTranslate3DTransform(jQuery(this).get(0),
(c()-d-x)/2)):a.is(":nth-of-type(1)")?I.mr_setTranslate3DTransform(jQuery(this).get(0),0===c()?0:c()/2):I.mr_setTranslate3DTransform(jQuery(this).get(0),(c()+r-d)/2)})};this.mr_setTranslate3DTransform=function(a,b){a.style[m]=n+b+q}}window.mr_parallax=new mr_parallax;
