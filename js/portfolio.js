...
document.getElementById('simplify').onclick = function() {
    ...
    if (this.innerHTML == "simplify") {
        fontStyledElems = document.querySelectorAll('.pacifico');
        for (var i = 0; i < fontStyledElems.length; i++) {
            var className = fontStyledElems[i].className.replace('pacifico', '');
            fontStyledElems[i].className = className;
        }
        this.innerHTML = "stylize";
    } else {
        for (var i = 0; i < fontStyledElems.length; i++) {
            fontStyledElems[i].className += ' pacifico';
        }
        this.innerHTML = "simplify";
    }
